---
title: Using Recovery Manager to fix shard map problems | Microsoft Azure
...
![Shard map](./media/sql-database-elastic-database-recovery-manager/recovery-manager.png)
