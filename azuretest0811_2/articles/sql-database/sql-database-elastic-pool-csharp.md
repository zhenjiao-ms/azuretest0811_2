---
title: 'C# database development: Elastic database pools | Microsoft Azure'
...
> [!NOTE]
> Elastic database pools are currently in preview and only available with SQL Database V12 servers. If you have a SQL Database V11 server you can [use PowerShell to upgrade to V12 and create a pool](sql-database-upgrade-server-powershell.md) in one step.
> 
> 
...
1. Scroll the menu on the left side to locate the **Active Directory** service and open it.
    ...
    ![C# SQL database development: Active Directory setup](./media/sql-database-elastic-pool-csharp/aad.png)
2. Select the directory to authenticate your application and click it's **Name**.
   
    ![Select a directory.](./media/sql-database-elastic-pool-csharp/aad2.png)
3. On the directory page, click **APPLICATIONS**.
   
    ![Click Applications.](./media/sql-database-elastic-pool-csharp/aad-applications.png)
4. Click **ADD** to create a new application.
   
    ![Click Add button: Create C# application.](./media/sql-database-elastic-pool-csharp/add.png)
...
6. Provide a **NAME** for the app, and select **NATIVE CLIENT APPLICATION**.
    ...
    ![Add application](./media/sql-database-elastic-pool-csharp/add-application.png)
7. Provide a **REDIRECT URI**. It doesn't need to be an actual endpoint, just a valid URI.
   
    ![Add application](./media/sql-database-elastic-pool-csharp/add-application2.png)
8. Finish creating the app, click **CONFIGURE**, and copy the **CLIENT ID** (you will need the client id in your code).
   
    ![Get client ID](./media/sql-database-elastic-pool-csharp/clientid.png)
9. On the bottom of the page click on **Add application**.
10. Select **Microsoft Apps**.
11. Select **Azure Service Management API**, and then complete the wizard.
12. With the API selected you now need to grant the specific permissions required to access this API by selecting **Access Azure Service Management (preview)**.
    
     ![Set permissions](./media/sql-database-elastic-pool-csharp/permissions.png)
13. Click **SAVE**.
...
2. Hover over your name in the upper right corner and note the Domain that appears in the pop-up window. Replace **domain.onmicrosoft.com** in the code snippet below with the value for your account.
    ...
    ![Identify domain name](./media/sql-database-elastic-pool-csharp/getdomain.png)
