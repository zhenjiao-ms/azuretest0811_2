...
2. On the left side select the **Active Directory** service and then select the directory to authenticate your application and click it's **Name**.
   
    ![Try SQL Database: Set up Azure Active Directory (AAD).](./media/sql-database-get-started-csharp/aad.png)
3. On the directory page, click **APPLICATIONS**.
   
    ![The directory page with Applications.](./media/sql-database-get-started-csharp/aad-applications.png)
...
6. Provide a **NAME** for the app, and select **NATIVE CLIENT APPLICATION**.
    ...
    ![Provide information about your SQL C# application.](./media/sql-database-get-started-csharp/add-application.png)
7. Provide a **REDIRECT URI**. It doesn't need to be an actual endpoint, just a valid URI.
   
    ![Add a redirect URL for your SQL C# application.](./media/sql-database-get-started-csharp/add-application2.png)
8. Finish creating the app, click **CONFIGURE**, and copy the **CLIENT ID** (you will need the client id later in your code).
   
    ![Get client ID for your SQL C# application.](./media/sql-database-get-started-csharp/clientid.png)
...
12. With the API selected you now need to grant the specific permissions required to access this API by selecting **Access Azure Service Management (preview)**.
     ...
     ![Set permissions.](./media/sql-database-get-started-csharp/permissions.png)
13. Click **SAVE**.
...
2. Hover over your name in the upper right corner and note the Domain that appears in the pop-up window.
    ...
    ![Identify the domain name.](./media/sql-database-get-started-csharp/getdomain.png)
