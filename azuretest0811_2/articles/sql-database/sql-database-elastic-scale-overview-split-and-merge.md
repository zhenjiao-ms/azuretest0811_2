---
title: Moving data between scaled-out cloud databases | Microsoft Azure
...
![Overview](./media/sql-database-elastic-scale-overview-split-and-merge/split-merge-overview.png)
...
![WADLogsTable](./media/sql-database-elastic-scale-overview-split-and-merge/diagnostics.png)
...
![Configuration](./media/sql-database-elastic-scale-overview-split-and-merge/diagnostics-config.png)
