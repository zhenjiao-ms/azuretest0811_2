---
title: Migrate existing databases to scale-out | Microsoft Azure
...
![List mapping](./media/sql-database-elastic-convert-to-use-elastic-tools/listmapping.png)
...
![Range mapping](./media/sql-database-elastic-convert-to-use-elastic-tools/rangemapping.png)
...
![Muliple tenants on single DB](./media/sql-database-elastic-convert-to-use-elastic-tools/multipleonsingledb.png) 
