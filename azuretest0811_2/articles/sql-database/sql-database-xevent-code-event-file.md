---
title: XEvent Event File code for SQL Database | Microsoft Azure
...
![PowerShell ISE, with Azure module installed, ready to run script.](./media/sql-database-xevent-code-event-file/event-file-powershell-ise-b30.png)
