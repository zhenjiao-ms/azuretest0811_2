...
![Elastic Scale terms](./media/sql-database-elastic-scale-glossary/glossary.png)
...
![Mappings](./media/sql-database-elastic-scale-glossary/mappings.png)
...
![Horizontal and vertical scaling](./media/sql-database-elastic-scale-glossary/h_versus_vert.png)
