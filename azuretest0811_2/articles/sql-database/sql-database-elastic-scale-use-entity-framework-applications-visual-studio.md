---
title: Using elastic database client library with Entity Framework | Microsoft Azure
...
* In the ‘New Project’ dialog, navigate to the **Online Samples** for **Visual C#** and type "elastic db" into the search box in the upper right.
    ...
    ![Entity Framework and elastic database sample app](./media/sql-database-elastic-scale-use-entity-framework-applications-visual-studio/sample.png) 
