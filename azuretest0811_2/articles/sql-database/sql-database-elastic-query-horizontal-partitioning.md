---
title: Reporting across scaled-out cloud databases | Microsoft Azure
...
![Query across shards](./media/sql-database-elastic-query-horizontal-partitioning/horizontalpartitioning.png)
