...
## Next Steps
Now that you understand how to use Node.js modules with Azure, learn how to [specify the Node.js version](nodejs-specify-node-version-azure-apps.md), [build and deploy a Node.js web app](app-service-web/web-sites-nodejs-develop-deploy-mac.md), and [How to use the Azure Command-Line Interface for Mac and Linux](xplat-cli-install.md).
