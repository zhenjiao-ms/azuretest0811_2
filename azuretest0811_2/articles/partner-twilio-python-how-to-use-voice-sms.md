---
title: How to Use Twilio for Voice and SMS (PHP) | Microsoft Azure
...
Twilio is a pay-as-you-go service. There are no set-up fees and you can close your account at any time. You can find more details at [Twilio Pricing](http://www.twilio.com/pricing).
...
When you are ready to get a Twilio account, sign up at [Try Twilio](https://www.twilio.com/try-twilio). You can start with a free account, and upgrade your account later.
...
A PHP application that uses the Twilio service and is running in Azure is no different than any other PHP application that uses the Twilio service. While Twilio services are REST-based and can be called from PHP in several ways, this article will focus on how to use Twilio services with [Twilio library for PHP from GitHub](https://github.com/twilio/twilio-php). For more information about using the Twilio library for PHP, see [http://readthedocs.org/docs/twilio-php/en/latest/index.html](http://readthedocs.org/docs/twilio-php/en/latest/index.html).

Detailed instructions for building and deploying a Twilio/PHP application to Azure are available at [How to Make a Phone Call Using Twilio in a PHP Application on Azure](http://windowsazure.com/documentation/articles/partner-twilio-php-make-phone-call).
...
1. Download the Twilio library for PHP from GitHub ([https://github.com/twilio/twilio-php](https://github.com/twilio/twilio-php)) and add the **Services** directory to your application.
...
For more information, see [https://github.com/twilio/twilio-php/blob/master/README.md](https://github.com/twilio/twilio-php/blob/master/README.md).
...
* **Note**: To troubleshoot SSL certificate validation errors, see [http://readthedocs.org/docs/twilio-php/en/latest/usage/rest.html](http://readthedocs.org/docs/twilio-php/en/latest/usage/rest.html)
...
When your application initiates a call to the Twilio API, Twilio will send your request to a URL that is expected to return a TwiML response. The example above uses the Twilio-provided URL [http://twimlets.com/message](http://twimlets.com/message). (While TwiML is designed for use by Twilio, you can view the it in your browser. For example, click [http://twimlets.com/message](http://twimlets.com/message) to see an empty `<Response>` element; as another example, click [http://twimlets.com/message?Message%5B0%5D=Hello%20World](http://twimlets.com/message?Message%5B0%5D=Hello%20World) to see a `<Response>` element that contains a `<Say>` element.)
...
For additional information about using Twilio in Azure with PHP, see [How to Make a Phone Call Using Twilio in a PHP Application on Azure](http://windowsazure.com/documentation/articles/partner-twilio-php-make-phone-call).
...
* [Twilio HowTo Guides and Example Code](http://www.twilio.com/docs/howto)
