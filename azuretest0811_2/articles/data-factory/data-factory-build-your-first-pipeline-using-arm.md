---
title: Build your first data factory (ARM template) | Microsoft Azure
...
> [!IMPORTANT]
> Change the values for **storageAccountName** and **storageAccountKey** variables. Change the **dataFactoryName** too because the name has to be unique.
> 
> 
...
> [!NOTE]
> You can find another example of ARM template for creating an Azure data factory on [Github](https://github.com/Azure/azure-quickstart-templates/blob/master/101-data-factory-blob-to-sql/azuredeploy.json).  
> 
> 
...
2. Run the following command to deploy Data Factory entities using the ARM template you created in Step 1. 
...
5. In the Diagram View, double-click on the dataset **AzureBlobOutput**. You will see that the slice that is currently being processed.
   
    ![Dataset](./media/data-factory-build-your-first-pipeline-using-arm/AzureBlobOutput.png)
6. When processing is done, you will see the slice in **Ready** state. Note that the creation of an on-demand HDInsight cluster usually takes sometime (approximately 20 minutes). 
