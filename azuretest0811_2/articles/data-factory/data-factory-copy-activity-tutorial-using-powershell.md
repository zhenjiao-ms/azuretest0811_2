---
title: 'Tutorial: Create a pipeline with Copy Activity using Azure PowerShell'
...
The [Copy data from Blob Storage to SQL Database](data-factory-copy-data-from-azure-blob-storage-to-sql-database.md) tutorial shows you how to create and monitor an Azure data factory using the [Azure Portal](http://portal.azure.com). 
