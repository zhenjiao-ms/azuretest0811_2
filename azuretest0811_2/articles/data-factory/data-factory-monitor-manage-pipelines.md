...
3. In the Data factories blade, select the data factory you are interested in and you should see the home page (**Data factory** blade) for the data factory.
...
1. Now, run the **Get-AzureRmDataFactoryRun** cmdlet to get details about activity run for the slice.
...
1. You should see the output with details about the error (similar to the following):
    ...
    Type                    :
2. You can run **Save-AzureRmDataFactoryLog** cmdlet with Id value you see from the above output and download the log files using the **-DownloadLogsoption** for the cmdlet.
...
> [!NOTE]
> The portal does not show alerts on events at this time. Please use the [Monitoring and Management App](data-factory-monitor-manage-app.md) to see all alerts.
> 
> 
...
> [!NOTE]
> You can use the [Create Alert Rule](https://msdn.microsoft.com/library/azure/dn510366.aspx) REST API to create an alert rule. The JSON payload is similar to the JSON example given above.  
> 
> 
