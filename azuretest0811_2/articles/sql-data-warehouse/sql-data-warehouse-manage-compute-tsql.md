...
To learn about this, see [Manage compute power overview](sql-data-warehouse-manage-compute-overview.md).
...
2. Use the [ALTER DATABASE](https://msdn.microsoft.com/library/mt204042.aspx) TSQL statement. The following example sets the service level objective to DW1000 for the database MySQLDW. 
