---
title: Group by options in SQL Data Warehouse | Microsoft Azure
...
The [GROUP BY](https://msdn.microsoft.com/library/ms177673.aspx) clause is used to aggregate data to a summary set of rows. It also has a few options that extend it's functionality that need to be worked around as they are not directly supported by Azure SQL Data Warehouse.
...
![](media/sql-data-warehouse-develop-group-by-options/sql-data-warehouse-develop-group-by-cube.png)
