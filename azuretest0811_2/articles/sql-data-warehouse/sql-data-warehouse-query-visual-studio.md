...
* An existing SQL data warehouse. To create one, see [Create a SQL Data Warehouse](sql-data-warehouse-get-started-provision.md).
...
* The fully qualified SQL server name. To find this, see [Connect to SQL Data Warehouse](sql-data-warehouse-connect-overview.md).
...
To configure your environment for Azure Active Directory authentication, see [Authenticate to SQL Data Warehouse](sql-data-warehouse-authentication.md).
