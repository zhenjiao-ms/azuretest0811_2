---
title: SQL Data Warehouse Transact-SQL reference | Microsoft Azure
...
## Next steps
For more TSQL examples, see [SQL Data Warehouse reference overview](sql-data-warehouse-overview-reference.md).
