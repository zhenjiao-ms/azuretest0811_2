---
title: SQL syntax and SQL query for DocumentDB | Microsoft Azure
...
![Architecture of supporting LINQ queries using DocumentDB - SQL syntax, JSON query language, database concepts and SQL queries](./media/documentdb-sql-query/sql-query1.png)
