---
title: 'ASP.NET MVC tutorial for DocumentDB: Web Application Development | Microsoft Azure'
...
1. Hit F5 in Visual Studio to build the application in debug mode. It should build the application and launch a browser with the empty grid page we saw before:
    ...
    If you are using Visual Studio 2013 and receive the error "Cannot await in the body of a catch clause." you need to install the [Microsoft.Net.Compilers nuget package](https://www.nuget.org/packages/Microsoft.Net.Compilers/). You can also compare your code against the sample project on [GitHub](https://github.com/Azure-Samples/documentdb-net-todo-app). 
...
To add additional functionality to your application, review the APIs available in the [DocumentDB .NET Library](https://msdn.microsoft.com/library/azure/dn948556.aspx) and feel free to contribute to the DocumentDB .NET Library on [GitHub](https://github.com/Azure-Samples/documentdb-net-todo-app). 
