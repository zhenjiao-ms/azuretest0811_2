...
* [UI Documentation - Reach - New Push Campaign](mobile-engagement-user-interface-reach-campaign.md)

## Audience criteria can include:
* **Technicals: ** You can target based on the same technical information you can see in the Analytics and Monitor sections. **See also:** [UI Documentation - Analytics](mobile-engagement-user-interface-analytics.md),  [UI Documentation - Monitor](mobile-engagement-user-interface-monitor.md)
...
* Segments: You can also target based on segments that you have created based on specific user behavior containing multiple criteria. All of your segments defined for your app show up on this list. **See also:** [UI Documentation -  Segments](mobile-engagement-user-interface-segments.md)
* **App Info:** Custom App Info Tags can be created from “Settings” to track user behavior. **See also:** [UI Documentation -  Settings](mobile-engagement-user-interface-settings.md)
...
![Reach-Criterion1](./media/mobile-engagement-user-interface-reach-criterion/Reach-Criterion1.png) 
