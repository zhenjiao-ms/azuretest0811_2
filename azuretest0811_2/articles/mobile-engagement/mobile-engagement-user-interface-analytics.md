...
![Analytics2](./media/mobile-engagement-user-interface-analytics/analytics2.png)

## Accessing the Retention Overview
![Analytics3](./media/mobile-engagement-user-interface-analytics/analytics3.png)
...
![Analytics4](./media/mobile-engagement-user-interface-analytics/analytics4.png)
