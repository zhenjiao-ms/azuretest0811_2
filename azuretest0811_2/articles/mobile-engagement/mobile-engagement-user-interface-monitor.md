...
![Monitor1](./media/mobile-engagement-user-interface-monitor/monitor1.png)  
...
For more information, see:  [SDK Documentation](http://go.microsoft.com/fwlink/?LinkID=525554)

![Monitor2](./media/mobile-engagement-user-interface-monitor/monitor2.png)  
...
For more information, see:  [SDK Documentation - Release notes](http://go.microsoft.com/fwlink/?LinkID=525554)

![Monitor3](./media/mobile-engagement-user-interface-monitor/monitor3.png)
...
![Monitor4](./media/mobile-engagement-user-interface-monitor/monitor4.png)
