---
title: Provide security contact details in Azure Security Center | Microsoft Azure
...
1. In the **Recommendations** blade, select **Provide security contact details**.
   ![Provide security contact](./media/security-center-provide-security-contacts/provide-contacts.png)
2. This opens the blade **Provide security contact details**. Select the Azure subscription to provide contact information on.
   ![Provide security contact details](./media/security-center-provide-security-contacts/provide-contact-details.png)
