---
title: How to monitor Azure Redis Cache | Microsoft Azure
...
![Enable cache diagnostics](./media/cache-how-to-monitor/redis-cache-enable-diagnostics.png)
...
![Diagnostics settings](./media/cache-how-to-monitor/redis-cache-diagnostic-settings.png)

![Configure diagnostics](./media/cache-how-to-monitor/redis-cache-configure-diagnostics.png)
...
![Redis metrics](./media/cache-how-to-monitor/redis-cache-redis-metrics.png)
...
![Metric blade](./media/cache-how-to-monitor/redis-cache-metric-blade.png)
...
![Edit chart](./media/cache-how-to-monitor/redis-cache-edit-chart.png)
...
![View chart details](./media/cache-how-to-monitor/redis-cache-view-chart-details.png)
...
![Monitor](./media/cache-how-to-monitor/redis-cache-premium-monitor.png)

Hovering the mouse over the data points displays the details for that point in time. 

![Monitor](./media/cache-how-to-monitor/redis-cache-premium-point-summary.png)
...
![Monitor](./media/cache-how-to-monitor/redis-cache-premium-point-shard.png)

To see more detail click the chart to view an expanded view on the **Metric** blade.

![Monitor](./media/cache-how-to-monitor/redis-cache-premium-chart-detail.png)
...
![Monitor](./media/cache-how-to-monitor/redis-cache-premium-edit.png)
...
![Oeprations](./media/cache-how-to-monitor/redis-cache-operations-events.png)
...
![Alert rules](./media/cache-how-to-monitor/redis-cache-alert-rules.png)
...
![Add alert rule](./media/cache-how-to-monitor/redis-cache-add-alert.png)
