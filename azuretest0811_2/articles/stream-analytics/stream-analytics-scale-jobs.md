---
title: Scale Stream Analytics jobs to increase throughput | Microsoft Azure
...
![Azure Stream Analytics Stream Units Scale](./media/stream-analytics-scale-jobs/StreamAnalyticsStreamingUnitsExample.jpg)
...
![Azure Portal Stream Analytics job configuration](./media/stream-analytics-scale-jobs/StreamAnalyticsPreviewPortalJobSettings.png)

## Monitor job performance
Using the management portal, you can track the throughput of a job in Events/second:

![Azure Stream Analytics monitor jobs](./media/stream-analytics-scale-jobs/StreamAnalytics.job.monitor.png)
