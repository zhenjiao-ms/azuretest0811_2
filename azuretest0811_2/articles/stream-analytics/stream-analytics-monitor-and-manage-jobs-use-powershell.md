---
title: Monitor and manage Stream Analytics jobs with PowerShell | Microsoft Azure
...
For detailed information on the JSON file structure and contents, refer to the [Create Input (Azure Stream Analytics)](https://msdn.microsoft.com/library/dn835010.aspx) section of the [Stream Analytics Management REST API Reference Library](http://go.microsoft.com/fwlink/?LinkId=517301).
...
For detailed information on the JSON file structure and contents, refer to the [Create Stream Analytics Job](https://msdn.microsoft.com/library/dn834994.aspx) section of the [Stream Analytics Management REST API Reference Library](http://go.microsoft.com/fwlink/?LinkId=517301).
...
For detailed information on the JSON file structure and contents, refer to the [Create Output (Azure Stream Analytics)](https://msdn.microsoft.com/library/dn835015.aspx) section of the [Stream Analytics Management REST API Reference Library](http://go.microsoft.com/fwlink/?LinkId=517301).
...
For detailed information on the JSON file structure and contents, refer to the [Create Transformation (Azure Stream Analytics)](https://msdn.microsoft.com/library/dn835007.aspx) section of the [Stream Analytics Management REST API Reference Library](http://go.microsoft.com/fwlink/?LinkId=517301).
