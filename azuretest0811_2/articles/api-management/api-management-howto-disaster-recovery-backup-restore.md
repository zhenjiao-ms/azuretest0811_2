...
![Create Azure Active Directory application](./media/api-management-howto-disaster-recovery-backup-restore/api-management-add-aad-application.png)
...
![Add permissions](./media/api-management-howto-disaster-recovery-backup-restore/api-management-aad-permissions-add.png)

Select **Windows** **Azure Service Management API** and click the checkbox to add the application.

![Add permissions](./media/api-management-howto-disaster-recovery-backup-restore/api-management-aad-permissions.png)
...
![Add permissions](./media/api-management-howto-disaster-recovery-backup-restore/api-management-aad-delegated-permissions.png)
...
![Endpoints](./media/api-management-howto-disaster-recovery-backup-restore/api-management-aad-default-directory.png)

![Endpoints](./media/api-management-howto-disaster-recovery-backup-restore/api-management-endpoint.png)
...
![Resources](./media/api-management-howto-disaster-recovery-backup-restore/api-management-aad-resources.png)

Once the values are specified, the code example should return a token similar to the following example.

![Token](./media/api-management-howto-disaster-recovery-backup-restore/api-management-arm-token.png)
...
* **Usage data** used for creating analytics reports **is not included** in the backup. Use [Azure API Management REST API](http://msdn.microsoft.com/library/azure/dn781421.aspx) to periodically retrieve analytics reports for safekeeping.
