...
![Azure Active Directory](./media/api-management-howto-protect-backend-with-aad/api-management-create-aad-menu.png)
...
![Azure Active Directory](./media/api-management-howto-protect-backend-with-aad/api-management-create-aad.png)
...
![Visual Studio](./media/api-management-howto-protect-backend-with-aad/api-management-new-web-app.png)
...
![New project](./media/api-management-howto-protect-backend-with-aad/api-management-new-project.png)
...
![Domains](./media/api-management-howto-protect-backend-with-aad/api-management-aad-domains.png)

Configure the desired settings in the **Change Authentication** dialog box and click **OK**.

![Change authentication](./media/api-management-howto-protect-backend-with-aad/api-management-change-authentication.png)
...
![Sign in to Visual Studio](./media/api-management-howto-protect-backend-with-aad/api-management-sign-in-vidual-studio.png)

To configure this project as an Azure Web API check the box for **Host in the cloud** and then click **OK**.

![New project](./media/api-management-howto-protect-backend-with-aad/api-management-new-project-cloud.png)

You may be prompted to sign in to Azure, and then you can configure the Web App.

![Configure](./media/api-management-howto-protect-backend-with-aad/api-management-configure-web-app.png)
...
![Add Controller](./media/api-management-howto-protect-backend-with-aad/api-management-add-controller.png)
...
![Web Publish](./media/api-management-howto-protect-backend-with-aad/api-management-web-publish.png)
...
![Application](./media/api-management-howto-protect-backend-with-aad/api-management-aad-backend-app.png)
...
![Add permissions](./media/api-management-howto-protect-backend-with-aad/api-management-aad-add-permissions.png)
...
![Import API button](./media/api-management-howto-protect-backend-with-aad/api-management-import-api.png)
...
![Add new API](./media/api-management-howto-protect-backend-with-aad/api-management-import-new-api.png)
...
![Developer portal](./media/api-management-howto-protect-backend-with-aad/api-management-developer-portal-menu.png)

Click **APIs** and click the **Calculator** API.

![Developer portal](./media/api-management-howto-protect-backend-with-aad/api-management-dev-portal-apis.png)

Click **Try it**.

![Try it](./media/api-management-howto-protect-backend-with-aad/api-management-dev-portal-try-it.png)

Click **Send** and note the response status of **401 Unauthorized**.

![Send](./media/api-management-howto-protect-backend-with-aad/api-management-dev-portal-send-401.png)
...
![New application](./media/api-management-howto-protect-backend-with-aad/api-management-aad-new-application-devportal.png)
...
![New application](./media/api-management-howto-protect-backend-with-aad/api-management-new-aad-application-menu.png)

Choose **Web application and/or Web API**, enter a name, and click the next arrow. In this example **APIMDeveloperPortal** is used.

![New application](./media/api-management-howto-protect-backend-with-aad/api-management-aad-new-application-devportal-1.png)
...
![New application](./media/api-management-howto-protect-backend-with-aad/api-management-aad-new-application-devportal-2.png)
...
![Add authorization server](./media/api-management-howto-protect-backend-with-aad/api-management-add-authorization-server.png)
...
![Add authorization server](./media/api-management-howto-protect-backend-with-aad/api-management-add-authorization-server-1.png)

Next, specify **Authorization endpoint URL** and **Token endpoint URL**.

![Authorization server](./media/api-management-howto-protect-backend-with-aad/api-management-add-authorization-server-1a.png)
...
![Application](./media/api-management-howto-protect-backend-with-aad/api-management-aad-devportal-application.png)

![View endpoints](./media/api-management-howto-protect-backend-with-aad/api-management-aad-view-endpoints.png)

Copy the **OAuth 2.0 authorization endpoint** and paste it into the **Authorization endpoint URL** textbox.

![Add authorization server](./media/api-management-howto-protect-backend-with-aad/api-management-add-authorization-server-2.png)

Copy the **OAuth 2.0 token endpoint** and paste it into the **Token endpoint URL** textbox.

![Add authorization server](./media/api-management-howto-protect-backend-with-aad/api-management-add-authorization-server-2a.png)
...
![Client credentials](./media/api-management-howto-protect-backend-with-aad/api-management-client-credentials.png)
...
![Client ID](./media/api-management-howto-protect-backend-with-aad/api-management-aad-client-id.png)
...
![Add authorization server](./media/api-management-howto-protect-backend-with-aad/api-management-add-authorization-server-3.png)
...
![Reply URL](./media/api-management-howto-protect-backend-with-aad/api-management-aad-reply-url.png)
...
![Add permissions](./media/api-management-howto-protect-backend-with-aad/api-management-add-devportal-permissions.png)

Click the search icon, type **APIM** into the Starting with box, select **APIMAADDemo**, and click the check mark to save.

![Add permissions](./media/api-management-howto-protect-backend-with-aad/api-management-aad-add-app-permissions.png)
...
![Add permissions](./media/api-management-howto-protect-backend-with-aad/api-management-aad-add-delegated-permissions.png)
...
![Calculator API](./media/api-management-howto-protect-backend-with-aad/api-management-calc-api.png)
...
![Calculator API](./media/api-management-howto-protect-backend-with-aad/api-management-enable-aad-calculator.png)
...
![Calculator API](./media/api-management-howto-protect-backend-with-aad/api-management-calc-authorization-server.png)
...
![Calculator API](./media/api-management-howto-protect-backend-with-aad/api-management-devportal-authorization-code.png)

Click **Send** and note the **Response status** of **200 OK** and the results of the operation in the response content.

![Calculator API](./media/api-management-howto-protect-backend-with-aad/api-management-devportal-response.png)
