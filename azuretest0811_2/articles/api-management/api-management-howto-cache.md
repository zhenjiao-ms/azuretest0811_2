---
title: Add caching to improve performance in Azure API Management | Microsoft Azure
...
> [!NOTE]
> Each API Management service instance comes preconfigured with an Echo API that can be used to experiment with and learn about API Management. For more information, see [Get started with Azure API Management](api-management-get-started.md).
> 
> 
...
![Publisher portal](./media/api-management-howto-cache/api-management-management-console.png)
...
![Developer portal](./media/api-management-howto-cache/api-management-developer-portal-menu.png)
...
* For more information about caching policies, see [Caching policies](https://msdn.microsoft.com/library/azure/dn894086.aspx) in the [API Management policy reference](https://msdn.microsoft.com/library/azure/dn894081.aspx).
* For information on caching items by key using policy expressions, see [Custom caching in Azure API Management](api-management-sample-cache-by-key.md).
