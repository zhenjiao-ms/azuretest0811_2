---
title: Manage your first API in Azure API Management | Microsoft Azure
...
> [!NOTE]
> To complete this tutorial, you need an Azure account. If you don't have an account, you can create a free account in just a couple of minutes. For details, see [Azure Free Trial](http://azure.microsoft.com/pricing/free-trial/?WT.mc_id=api_management_hero_a).
> 
> 

The first step in working with API Management is to create a service instance. Sign in to the [Azure Classic Portal](https://manage.windowsazure.com/) and click **New**, **App Services**, **API Management**, **Create**.
...
> [!NOTE]
> This email address is used for notifications from the API Management system. For more information, see [How to configure notifications and email templates in Azure API Management](api-management-howto-configure-notifications.md).
> 
> 

![New API Management service](./media/api-management-get-started/api-management-create-instance-step2.png)
...
> [!NOTE]
> The Developer Tier is for development, testing, and pilot API programs where high availability is not a concern. In the Standard and Premium tiers, you can scale your reserved unit count to handle more traffic. The Standard and Premium tiers provide your API Management service with the most processing power and performance. You can complete this tutorial by using any tier. For more information about API Management tiers, see [API Management pricing](http://azure.microsoft.com/pricing/details/api-management/).
> 
> 

Click the check box to create your service instance.

![New API Management service](./media/api-management-get-started/api-management-instance-created.png)
...
![Publisher portal](./media/api-management-get-started/api-management-management-console.png)

To import the calculator API, click **APIs** from the **API Management** menu on the left, and then click **Import API**.

![Import API button](./media/api-management-get-started/api-management-import-api.png)
...
![Add new API](./media/api-management-get-started/api-management-import-new-api.png)
...
![API summary](./media/api-management-get-started/api-management-imported-api-summary.png)
...
![Developer portal](./media/api-management-get-started/api-management-developer-portal-calc-api.png)
...
![Try it](./media/api-management-get-started/api-management-developer-portal-calc-api-console.png)
...
* Check out the other topics in the [Get started with advanced API configuration](api-management-get-started-advanced.md) tutorial.
