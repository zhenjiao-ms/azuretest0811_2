---
title: How to add operations to an API in Azure API Management | Microsoft Azure
...
![Publisher portal](./media/api-management-howto-add-operations/api-management-management-console.png)
...
> For more information on caching and caching policies, see [How to cache operation results in Azure API Management](api-management-howto-cache.md).
> 
> 
