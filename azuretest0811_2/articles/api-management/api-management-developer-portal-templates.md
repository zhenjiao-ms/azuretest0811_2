---
title: How to customize the Azure API Management developer portal using templates | Microsoft Azure
...
![Developer portal](./media/api-management-developer-portal-templates/api-management-browse.png)

If you are already in the publisher portal, you can access the developer portal by clicking **Developer portal**.

![Developer portal menu](./media/api-management-developer-portal-templates/api-management-developer-portal-menu.png)
...
![Developer portal templates](./media/api-management-developer-portal-templates/api-management-customize-menu.png)
...
![Developer portal templates](./media/api-management-developer-portal-templates/api-management-templates-menu.png)
...
![Products list template](./media/api-management-developer-portal-templates/api-management-developer-portal-templates-overview.png)

Some templates, like the **User Profile** templates, customize different parts of the same page. 

![User profile templates](./media/api-management-developer-portal-templates/api-management-user-profile-templates.png)
...
![Template markup](./media/api-management-developer-portal-templates/api-management-template.png)
...
![Template data model](./media/api-management-developer-portal-templates/api-management-template-data.png)
...
![Save template](./media/api-management-developer-portal-templates/api-management-save-template.png)
...
![Publish template](./media/api-management-developer-portal-templates/api-management-publish-template.png)

Click **Yes** to confirm and make the template live on the developer portal.

![Confirm publish](./media/api-management-developer-portal-templates/api-management-publish-template-confirm.png)
...
![Publish templates](./media/api-management-developer-portal-templates/api-management-publish-templates.png)

Click **Publish customizations** to confirm.

![Confirm publish](./media/api-management-developer-portal-templates/api-management-publish-customizations.png)
...
![Revert template](./media/api-management-developer-portal-templates/api-management-revert-template.png)

Click **Yes** to confirm.

![Confirm](./media/api-management-developer-portal-templates/api-management-revert-template-confirm.png)
...
![Revert template](./media/api-management-developer-portal-templates/api-management-reset-template.png)

Click **Yes** to confirm.

![Confirm](./media/api-management-developer-portal-templates/api-management-reset-template-confirm.png)

To restore all templates to their default versions, click **Restore default templates** on the template list.

![Restore templates](./media/api-management-developer-portal-templates/api-management-restore-templates.png)
