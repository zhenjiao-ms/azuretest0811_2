...
> If you haven't yet created an API Management service instance, see [Create an API Management service instance](api-management-get-started.md#create-service-instance) in the [Get started with Azure API Management](api-management-get-started.md) tutorial.
> 
> 
...
![Echo API](./media/api-management-howto-api-inspector/api-management-api.png)

Click **Try it** to try the **Add two integers** operation.

![Try it](./media/api-management-howto-api-inspector/api-management-open-console.png)
...
![Send](./media/api-management-howto-api-inspector/api-management-http-get.png)

Click **Send** to invoke the operation.

![Send](./media/api-management-howto-api-inspector/api-management-send-results.png)
