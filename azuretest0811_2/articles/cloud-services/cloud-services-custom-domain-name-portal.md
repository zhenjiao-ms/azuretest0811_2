...
1. Use one of these methods to find the **.cloudapp.net** domain name assigned to your cloud service.
   ...
   * Login to the [Azure portal](https://portal.azure.com), select your cloud service, look at the **Essentials** section and then find the **Site URL** entry.
     
       ![quick glance section showing the site URL](./media/cloud-services-custom-domain-name-portal/csurl.png)
...
1. Use one of the following methods to get the IP address of your cloud service.
   ...
   * Login to the [Azure portal](https://portal.azure.com), select your cloud service, look at the **Essentials** section and then find the **Public IP addresses** entry.
     
       ![quick glance section showing the VIP](./media/cloud-services-custom-domain-name-portal/csvip.png)
