---
title: Profiling a Cloud Service Locally in the Compute Emulator | Microsoft Azure
...
data and then analyze it locally, as described in [Profiling an Azure Application](http://msdn.microsoft.com/library/azure/hh369930.aspx).
You can also use diagnostics to track a variety of performance
counters, as described in [Using performance counters in Azure](http://msdn.microsoft.com/library/azure/hh411542.aspx).
...
![Symbol options](./media/cloud-services-performance-testing-visual-studio-profiler/ProfilingLocally09.png)
...
![Just My Code options](./media/cloud-services-performance-testing-visual-studio-profiler/ProfilingLocally08.png)
...
![Azure Cloud Service project roles](./media/cloud-services-performance-testing-visual-studio-profiler/ProfilingLocally10.png)
...
![Attach profile option](./media/cloud-services-performance-testing-visual-studio-profiler/ProfilingLocally02.png)

For a worker role, find the WaWorkerHost.exe process.

![WaWorkerHost process](./media/cloud-services-performance-testing-visual-studio-profiler/ProfilingLocally05.png)
...
![Start the Compute Emulator UI](./media/cloud-services-performance-testing-visual-studio-profiler/ProfilingLocally010.png)
...
![View process ID](./media/cloud-services-performance-testing-visual-studio-profiler/ProfilingLocally07.png)
...
![Stop Profiling option](./media/cloud-services-performance-testing-visual-studio-profiler/ProfilingLocally06.png)
...
![Profiler report](./media/cloud-services-performance-testing-visual-studio-profiler/ProfilingLocally03.png)
...
![Analysis of report](./media/cloud-services-performance-testing-visual-studio-profiler/ProfilingLocally011.png)
...
![Performance warnings](./media/cloud-services-performance-testing-visual-studio-profiler/ProfilingLocally04.png)
...
![Compare performance reports option](./media/cloud-services-performance-testing-visual-studio-profiler/ProfilingLocally013.png)

The reports highlight differences between the two runs.

![Comparison report](./media/cloud-services-performance-testing-visual-studio-profiler/ProfilingLocally012.png)
