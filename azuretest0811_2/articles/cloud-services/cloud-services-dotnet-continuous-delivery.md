---
title: Continuous delivery for cloud services with TFS in Azure | Microsoft Azure
...
1. In Visual Studio on your development computer, on the View
   ...
   ![New Build Definition option](./media/cloud-services-dotnet-continuous-delivery/tfs-01bc.png)
...
6. Choose **MSBuild Arguments**, and set the appropriate MSBuild
   ...
   ![MSBuild arguments](./media/cloud-services-dotnet-continuous-delivery/tfs-02.png)
...
6. Add the following list of new arguments as separate line items in
   ...
   ![List of arguments](./media/cloud-services-dotnet-continuous-delivery/common-task-tfs-03.png)
...
7. Add a new sequence at the end of Run On Agent:
   ...
   3. With the Start publish sequence still selected, add the
      ...
      * PublishScriptFilePath, of type String
        ...
        ![New variables](./media/cloud-services-dotnet-continuous-delivery/common-task-tfs-04.png)
   ...
   ![Workflow activities](./media/cloud-services-dotnet-continuous-delivery/common-task-tfs-05.png)
...
10. Set the parameter property values in the Misc section as follows:
    ...
    ![Parameter property values](./media/cloud-services-dotnet-continuous-delivery/common-task-tfs-06.png)
