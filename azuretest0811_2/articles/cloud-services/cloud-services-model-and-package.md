---
title: What is a Cloud Service model and package | Microsoft Azure
...
* I am using Visual Studio and I want to...
  * [Create a new cloud service](../vs-azure-tools-azure-project-create.md)
  * [Reconfigure an existing cloud service](../vs-azure-tools-configure-roles-for-cloud-service.md)
  * [Deploy a Cloud Service project](../vs-azure-tools-cloud-service-publish-set-up-required-services-in-visual-studio.md)
  * [Remote desktop into a cloud service instance](cloud-services-role-enable-remote-desktop.md)
...
* [Setup remote desktop for a cloud service instance](cloud-services-role-enable-remote-desktop.md)
* [Deploy a Cloud Service project](cloud-services-how-to-create-deploy-portal.md)
...
* [Reconfigure an existing cloud service](../vs-azure-tools-configure-roles-for-cloud-service.md)
* [Deploy a Cloud Service project](../vs-azure-tools-cloud-service-publish-set-up-required-services-in-visual-studio.md)
* [Setup remote desktop for a cloud service instance](../vs-azure-tools-remote-desktop-roles.md)
