...
1. Use one of these methods to find the **.cloudapp.net** domain name assigned to your cloud service.
   ...
   * Login to the [Azure classic portal](https://manage.windowsazure.com), select your cloud service, select **Dashboard**, and then find the **Site URL** entry in the **quick glance** section.
     
       ![quick glance section showing the site URL](./media/cloud-services-custom-domain-name/csurl.png)
...
1. Use one of the following methods to get the IP address of your cloud service.
   ...
   * login to the [Azure classic portal](https://manage.windowsazure.com), select your cloud service, select **Dashboard**, and then find the **Public Virtual IP (VIP) address** entry in the **quick glance** section.
     
       ![quick glance section showing the VIP](./media/cloud-services-custom-domain-name/csvip.png)
