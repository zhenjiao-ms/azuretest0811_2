---
title: Using JSON files in blob storage | Microsoft Azure
...
> [!NOTE]
> You will not be able to see the configuration in the Azure portal. You can verify configuration using the `Get-AzureRmOperationalInsightsStorageInsight` cmdlet.  
> 
> 
