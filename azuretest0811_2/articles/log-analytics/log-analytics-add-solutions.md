---
title: Add Log Analytics solutions from the Solutions Gallery | Microsoft Azure
...
> [!NOTE]
> Log Analytics includes Log Search functionality, so you don't need to install a solution to enable it. However, you can get data visualizations, suggested searches and insights by adding solutions from the Solution Gallery.
> 
> 
