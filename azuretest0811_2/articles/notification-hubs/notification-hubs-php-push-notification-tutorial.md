...
You can find all the code available in the [PHP REST wrapper sample](https://github.com/Azure/azure-notificationhubs-samples/tree/master/notificationhubs-rest-php).
...
## Implementation
If you did not already, please follow our [Get started tutorial](http://azure.microsoft.com/documentation/articles/notification-hubs-ios-get-started/) up to the last section where you have to implement the back-end.
Also, if you want you can use the code from the [PHP REST wrapper sample](https://github.com/Azure/azure-notificationhubs-samples/tree/master/notificationhubs-rest-php) and go directly to the [Complete the tutorial](#complete-tutorial) section.
...
Initialize your Notification Hubs client (substitute the connection string and hub name as instructed in the [Get started tutorial](http://azure.microsoft.com/documentation/articles/notification-hubs-ios-get-started/)):
...
* Download the full [PHP REST wrapper sample](https://github.com/Azure/azure-notificationhubs-samples/tree/master/notificationhubs-rest-php), which contains all the code above.
