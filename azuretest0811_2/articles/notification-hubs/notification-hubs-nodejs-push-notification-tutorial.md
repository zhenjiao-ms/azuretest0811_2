...
The first step in this tutorial is creating a new blank Node.js application. For instructions on creating a Node.js application, see [Create and deploy a Node.js application to Azure Web Site](/develop/nodejs/tutorials/create-a-website-\(mac\)/), [Node.js Cloud Service][Node.js Cloud Service](using Windows PowerShell.md), or [Web Site with WebMatrix].
...
The connection **connectionstring** value can be obtained from the [Azure Portal](https://portal.azure.com) by performing the following steps:
