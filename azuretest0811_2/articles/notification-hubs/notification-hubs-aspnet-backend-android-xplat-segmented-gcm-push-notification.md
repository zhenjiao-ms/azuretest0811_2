...
## Prerequisites
This topic builds on the app you created in [Get started with Notification Hubs](notification-hubs-android-push-notification-google-gcm-get-started.md). Before starting this tutorial, you must have already completed [Get started with Notification Hubs](notification-hubs-android-push-notification-google-gcm-get-started.md).
