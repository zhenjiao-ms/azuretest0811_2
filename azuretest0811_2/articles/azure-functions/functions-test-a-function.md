---
title: Testing Azure Functions | Microsoft Azure
...
1. In the [Azure Portal](https://portal.azure.com) for your Functions app, create a new C# or Node blob trigger function. Set the path to monitor to the name of your blob container. For example:
...
1. In the [Azure Portal](https://portal.azure.com) for your Functions app, click **New Function** > **QueueTrigger - C#**.
...
1. Open the [Azure Portal](https://portal.azure.com) in a new browser window and navigate to your Function app.
