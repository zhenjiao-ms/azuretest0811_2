---
title: 'Tutorial: Azure Active Directory integration with Workrite | Microsoft Azure'
...
1. In the **Azure classic portal**, on the left navigation pane, click **Active Directory**. 
    ...
    ![Active Directory](./media/active-directory-saas-workrite-tutorial/tutorial_general_01.png)
2. From the **Directory** list, select the directory for which you want to enable directory integration.
3. To open the applications view, in the directory view, click **Applications** in the top menu.
   
    ![Applications](./media/active-directory-saas-workrite-tutorial/tutorial_general_02.png)
4. Click **Add** at the bottom of the page.
   
    ![Applications](./media/active-directory-saas-workrite-tutorial/tutorial_general_03.png)
5. On the **What do you want to do** dialog, click **Add an application from the gallery**.
   
    ![Applications](./media/active-directory-saas-workrite-tutorial/tutorial_general_04.png)
6. In the search box, type **Workrite**.
   
    ![Applications](./media/active-directory-saas-workrite-tutorial/tutorial_workrite_01.png)
7. In the results pane, select **Workrite**, and then click **Complete** to add the application.
   
    ![Applications](./media/active-directory-saas-workrite-tutorial/tutorial_workrite_05.png)
...
1. In the Azure classic portal, on the **Workrite** application integration page, click **Configure single sign-on** to open the **Configure Single Sign-On**  dialog.
    ...
    ![Configure Single Sign-On](./media/active-directory-saas-workrite-tutorial/tutorial_general_05.png) 
2. On the **How would you like users to sign on to Workrite** page, select **Azure AD Single Sign-On**, and then click **Next**.
   
    ![Azure AD Single Sign-On](./media/active-directory-saas-workrite-tutorial/tutorial_workrite_02.png) 
3. On the **Configure App Settings** dialog page, perform the following steps:
   
    ![Azure AD Single Sign-On](./media/active-directory-saas-workrite-tutorial/tutorial_workrite_03.png) 
...
4. On the **Configure single sign-on at Workrite** page, perform the following steps:
    ...
    ![Azure AD Single Sign-On](./media/active-directory-saas-workrite-tutorial/tutorial_workrite_04.png) 
...
5. On the Azure classic portal, select the single sign-on configuration confirmation, and then click **Next**. 
    ...
    ![Azure AD Single Sign-On](./media/active-directory-saas-workrite-tutorial/tutorial_general_06.png)
6. On the **Single sign-on confirmation** page, click **Complete**.  
   
    ![Azure AD Single Sign-On](./media/active-directory-saas-workrite-tutorial/tutorial_general_07.png)

### Creating an Azure AD test user
The objective of this section is to create a test user in the Azure classic portal called Britta Simon.  

![Create Azure AD User](./media/active-directory-saas-workrite-tutorial/tutorial_general_100.png)
...
2. In the navigation pane, click **Admin**.
    ...
    ![Assign User](./media/active-directory-saas-workrite-tutorial/tutorial_workrite_400.png)
3. Go to Quick Links, and then click **Create User**. 
   
    ![Assign User](./media/active-directory-saas-workrite-tutorial/tutorial_workrite_401.png)
4. On the **Create User** dialog, perform the following steps:
   
    ![Assign User](./media/active-directory-saas-workrite-tutorial/tutorial_workrite_402.png)
...
1. On the Azure classic portal, to open the applications view, in the directory view, click **Applications** in the top menu.
    ...
    ![Assign User](./media/active-directory-saas-workrite-tutorial/tutorial_general_201.png) 
2. In the applications list, select **Workrite**.
   
    ![Assign User](./media/active-directory-saas-workrite-tutorial/tutorial_workrite_07.png) 
3. In the menu on the top, click **Users**.
   
    ![Assign User](./media/active-directory-saas-workrite-tutorial/tutorial_general_203.png) 
4. In the Users list, select **Britta Simon**.
5. In the toolbar on the bottom, click **Assign**.
   
    ![Assign User](./media/active-directory-saas-workrite-tutorial/tutorial_general_205.png)
