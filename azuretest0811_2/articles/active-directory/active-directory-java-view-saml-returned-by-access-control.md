...
## Next steps
To further explore ACS's functionality and to experiment with more sophisticated scenarios, see [Access Control Service 2.0](http://go.microsoft.com/fwlink/?LinkID=212360).
