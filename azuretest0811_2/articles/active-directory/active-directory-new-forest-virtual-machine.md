---
title: Install an Active Directory forest on an Azure virtual network | Microsoft Azure
...
![Active Directory forest on a virtual machines in Azure Virtual Network ](./media/active-directory-new-forest-virtual-machine/AD_Forest.png)
7
