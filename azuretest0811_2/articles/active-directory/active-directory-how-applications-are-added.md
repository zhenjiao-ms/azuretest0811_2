...
![A diagram illustrating how application objects and service principals existing with Azure AD instances.](media/active-directory-how-applications-are-added/HowAppsAreAddedToAAD.jpg)
...
![A screenshot of the UI for configuring integrated app settings](media/active-directory-how-applications-are-added/IntegratedAppSettings.jpg)
