---
title: What is application access and single sign-on with Azure Active Directory? | Microsoft Azure
...
![](./media/active-directory-appssoaccess-whatis/onlineappgallery.png)
...
![](./media/active-directory-appssoaccess-whatis/azuremgmtportal.png)
...
![](./media/active-directory-appssoaccess-whatis/accesspanel.png)
...
![](./media/active-directory-appssoaccess-whatis/officeapphub.png)
...
![](./media/active-directory-appssoaccess-whatis/workdaymobile.png)
...
![](./media/active-directory-appssoaccess-whatis/deeplink.png)
