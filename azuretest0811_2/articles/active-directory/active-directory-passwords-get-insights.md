...
5. Select either the **Password reset activity** report or the **Password reset registration activity** report.
   ...
   ![](./media/active-directory-passwords-get-insights/001.jpg "Image_001.jpg")
...
* **Downloadable**: Yes, via CSV file
    ...
    ![](./media/active-directory-passwords-get-insights/002.jpg "Image_002.jpg")
...
* **Downloadable**: Yes, via CSV file
    ...
    ![](./media/active-directory-passwords-get-insights/003.jpg "Image_003.jpg")
