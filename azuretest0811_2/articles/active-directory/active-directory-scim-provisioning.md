---
title: Using SCIM to enable automatic provisioning of users and groups from Azure Active Directory to applications | Microsoft Azure
...
![](./media/active-directory-scim-provisioning/scim-figure-1.PNG)
...
![](./media/active-directory-scim-provisioning/scim-figure-2.PNG)
...
4. Click **Next**, and click on the **Start Test** button to have Azure Active Directory attempt to connect to the SCIM endpoint. If the attempts fail, diagnostic information will be displayed.  
...
![](./media/active-directory-scim-provisioning/scim-figure-3.PNG)
...
![](./media/active-directory-scim-provisioning/scim-figure-4.PNG)
...
![](./media/active-directory-scim-provisioning/scim-figure-5.PNG)
