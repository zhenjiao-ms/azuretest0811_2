---
title: Get started with delivering content on demand using REST API
...
4. Configure streaming units with REST API.
...
> [!NOTE]
> From now on the new URI will be used in this tutorial.
> 
> 
