---
title: How to perform live streaming using Azure Media Services to create multi-bitrate streams with the Azure Classic Portal
...
5. Create a program (that will also create an asset). 
6. Publish the program (that will create an  OnDemand locator for the associated asset).  
...
1. Alternatively, you can use a shortcut and press **START STREAMING** button on the **CHANNEL** page. This will create an Asset, Program, and Streaming Locator.
