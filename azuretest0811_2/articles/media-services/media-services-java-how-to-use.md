---
title: How to use Azure Media Services with Java
...
* The Azure Libraries for Java, which you can install from the [Azure Java Developer Center](http://azure.microsoft.com/develop/java/).
...
For Media Services Javadoc documentation, see [Azure Libraries for Java documentation](http://dl.windowsazure.com/javadoc/).
