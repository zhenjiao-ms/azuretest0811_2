...
8. MP4 fragment timestamps and indexes (TrackFragmentExtendedHeaderBox fragment* absolute* time and fragment_index) SHOULD arrive in increasing order.  Although Azure Media Services is resilient to duplicate fragments, it has very limited ability to reorder fragments according to the media timeline.
