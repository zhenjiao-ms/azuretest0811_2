---
title: Filters and Dynamic Manifests
...
![Rendition filtering example](./media/media-services-dynamic-manifest-overview/media-services-rendition-filter2.png)
...
![Rendition filtering](./media/media-services-dynamic-manifest-overview/media-services-rendition-filter.png)
...
![Language tracks filtering](./media/media-services-dynamic-manifest-overview/media-services-language-filter.png)
...
![Trimming start](./media/media-services-dynamic-manifest-overview/media-services-trim-filter.png)
...
![Subclip filter](./media/media-services-dynamic-manifest-overview/media-services-subclips-filter.png)
...
![DVR window](./media/media-services-dynamic-manifest-overview/media-services-dvr-filter.png)
