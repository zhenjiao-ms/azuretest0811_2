---
title: How to Manage Streaming Endpoints in a Media Services Account
...
![Streaming Endpoint page](./media/media-services-manage-origins/media-services-origins-page.png)
...
2. Press the SAVE button to save your changes.
