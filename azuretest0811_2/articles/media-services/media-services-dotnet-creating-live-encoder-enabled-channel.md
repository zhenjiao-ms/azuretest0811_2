...
> [!NOTE]
> To find the Name and Key values, go to the Azure Classic Portal, select your Media Service account, and click on the “MANAGE KEYS” icon on the bottom of the portal window. Clicking on the icon next to each text box copies the value to the system clipboard.
> 
> 
