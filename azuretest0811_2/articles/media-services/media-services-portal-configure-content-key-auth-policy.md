---
title: Configure Content Key Authorization Policy using Portal
...
![OpenPolicy](./media/media-services-portal-configure-content-key-auth-policy/media-services-protect-content-with-open-restriction.png)
