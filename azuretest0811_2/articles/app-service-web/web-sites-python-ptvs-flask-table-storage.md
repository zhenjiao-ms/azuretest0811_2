...
2. The project templates from the [Python Tools 2.2 for Visual Studio Samples VSIX](http://go.microsoft.com/fwlink/?LinkID=624025) are available under **Python**, **Samples**. Select **Polls Flask Web Project** and click OK to create the project.
...
3. Click the **Access Keys** part in the storage account's blade. Take note of the account name and the key1.
      ...
      ![Keys](./media/web-sites-python-ptvs-flask-table-storage/PollsCommonAzureStorageKeys.png)
...
3. The code that implements the Azure Table Storage repository is in **models/azuretablestorage.py**. See the [documentation](../storage/storage-python-how-to-use-table-storage.md) for more information on how to use Table Service from Python.
