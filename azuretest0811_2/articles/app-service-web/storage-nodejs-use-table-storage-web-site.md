...
* [node](http://nodejs.org) version 0.10.24 or higher
...
3. In the storage account's blade, click **Settings** > **Keys**. Copy the primary access key to the clipboard.
    ...
    ![Access key](./media/storage-nodejs-use-table-storage-web-site/manage-access-keys.png)
...
> [!NOTE]
> These steps can also be performed by using the [Azure Portal](https://portal.azure.com/). See [Build and deploy a Node.js web app in Azure App Service](web-sites-nodejs-develop-deploy-mac.md).
> 
> If this is the first web app you have created, you must use the Azure Portal to deploy this application.
> 
> 

To get started, install the [Azure CLI](../xplat-cli-install.md) by entering the following command from the command line:
