...
This document is focused primarily on using the Azure Portal for VNET Integration.  To enable VNET Integration with your app using PowerShell, follow the directions here: [Connect your app to your virtual network by using PowerShell](http://azure.microsoft.com/documentation/articles/app-service-vnet-integration-powershell/).
...
![](./media/web-sites-integrate-with-vnet/vnetint-upgradeplan.png)
...
![](./media/web-sites-integrate-with-vnet/vnetint-existingvnet.png)
...
If your VNET does not have a gateway nor has Point to Site then you have to set that up first.  To do this for a V1 VNET, go to the [Azure Portal](http://portal.azure.com/) and bring up the list of Virtual Networks(classic).  From here click on the network you want to integrate with and click on the big box under Essentials called VPN Connections.  From here you can create your point to site VPN and even have it create a gateway.  After you go through the point to site with gateway creation experience it will be about 30 minutes before it is ready.  

![](./media/web-sites-integrate-with-vnet/vnetint-vnetp2s.png)

##### Enabling Point to Site in a V2 VNET
To configure a V2 VNET with a gateway and Point to Site you need to use PowerShell as documented here, [Configure a Point-to-Site connection to a virtual network using PowerShell](http://azure.microsoft.com/documentation/articles/vpn-gateway-howto-point-to-site-rm-ps/).  The UI to perform this capability is not yet available. 
...
> [!NOTE]
> V2 VNET creation with a gateway takes about 30 minutes and currently will not integrate the VNET with your app.  After your VNET is created with the gateway you need to come back to your app VNET Integration UI and select your new VNET.
> 
> 

![](./media/web-sites-integrate-with-vnet/vnetint-createvnet.png)
...
![](./media/web-sites-integrate-with-vnet/vnetint-howitworks.png)
...
![](./media/web-sites-integrate-with-vnet/vnetint-appmanage.png)
...
![](./media/web-sites-integrate-with-vnet/vnetint-aspmanage.png)
...
![](./media/web-sites-integrate-with-vnet/vnetint-aspmanagedetail.png)
...
For your apps to be able to use this feature, they need to be in a Standard or Premium App Service Plan.  You can see more details on those costs here: [App Service Pricing](http://azure.microsoft.com/pricing/details/app-service/). 
