...
Diagnostics for Node.js applications hosted on Azure is provided by [IISNode](https://github.com/tjanczuk/iisnode). While this article discusses the most common settings for gathering diagnostics information, it does not provide a complete reference for working with IISNode. For more information on working with IISNode, see the [IISNode Readme](https://github.com/tjanczuk/iisnode#readme) on GitHub.
...
For information on specifying a Node.js version for your application, see [Specifying a Node.js version in an Azure application](../nodejs-specify-node-version-azure-apps.md).
