...
This tutorial works with the development environment, web project, and Azure web app that you set up in [Get started with Azure and ASP.NET](web-sites-dotnet-get-started.md). For the WebJobs sections, you'll need the application that you create in [Get Started with the Azure WebJobs SDK](websites-dotnet-webjobs-sdk.md).
...
3. Expand the resource group that includes the web app that you created in [Getting started with Azure and ASP.NET](web-sites-dotnet-get-started.md), and then right-click the web app node and click **View Settings**.
...
This section shows how to debug remotely using the project you create in [Getting started with Azure and ASP.NET](web-sites-dotnet-get-started.md).

1. Open the web project that you created in [Getting started with Azure and ASP.NET](web-sites-dotnet-get-started.md).
...
6. In the **Profile** drop-down list, select the same profile that you used in [Getting started with Azure and ASP.NET](web-sites-dotnet-get-started.md).
...
1. Open the web project that you created in [Get Started with the Azure WebJobs SDK](websites-dotnet-webjobs-sdk.md).
...
* Add tracing statements to the web project that you created in [Get started with Azure and ASP.NET](web-sites-dotnet-get-started.md).
...
6. In the classic portal's **Configure** tab, scroll down to the application diagnostics section, and then change **Application Logging (Table Storage)** to **On**.
...
4. In the [Azure Portal](https://portal.azure.com) **Settings** blade for your web app, click **Deployment credentials**, and then enter a new user name and password.
