...
![Conceptual Architecture](./media/app-service-app-service-environment-geo-distributed-scale/ConceptualArchitecture-1.png) 
...
* **Traffic Manager domain:**  A domain name needs to be chosen when creating an [Azure Traffic Manager profile](https://azure.microsoft.com/documentation/articles/traffic-manager-manage-profiles/).  This name will be combined with the *trafficmanager.net* suffix to register a domain entry that is managed by Traffic Manager.  For the sample app, the name chosen is *scalable-ase-demo*.  As a result the full domain name that is managed by Traffic Manager is *scalable-ase-demo.trafficmanager.net*.
...
The easiest way to register multiple Azure App Service endpoints, all running in the **same** Azure region, is with the preview Powershell [Azure Resource Manager (ARM) Traffic Manager support](https://azure.microsoft.com/documentation/articles/traffic-manager-powershell-arm/).  
...
![CNAME for Custom Domain](./media/app-service-app-service-environment-geo-distributed-scale/CNAMECustomDomain-1.png) 
...
![Custom Domain](./media/app-service-app-service-environment-geo-distributed-scale/CustomDomain-1.png) 

For a recap of of registering a custom domain with Azure App Service apps, see the following article on [registering custom domains](https://azure.microsoft.com/en-us/documentation/articles/web-sites-custom-domain-name/).
...
![DNS Lookup](./media/app-service-app-service-environment-geo-distributed-scale/DNSLookup-1.png) 
...
Documentation on the preview Powershell [Azure Resource Manager (ARM) Traffic Manager support](https://azure.microsoft.com/documentation/articles/traffic-manager-powershell-arm/).  
