...
Using Git, you can deploy an ASP.NET application to Azure App Service Web Apps. In this tutorial, you will build a simple front-end ASP.NET MVC task list application that connects to a MongoDB database running on a virtual machine in Azure.  [MongoDB](http://www.mongodb.org) is a popular open source, high performance NoSQL database. After running and testing the ASP.NET application on your development computer, you will upload the application to App Service Web Apps using Git.
...
* The C# driver for MongoDB. For more information on developing C# applications against MongoDB, see the MongoDB [CSharp Language Center](http://docs.mongodb.org/ecosystem/drivers/csharp/). 
* The ASP .NET web application framework. You can learn all about it at the [ASP.net website](http://www.asp.net/).
* The ASP .NET MVC web application framework. You can learn all about it at the [ASP.NET MVC website](http://www.asp.net/mvc).
* Azure. You can get started reading at [Azure](http://www.windowsazure.com).

## Prerequisites
* [Visual Studio Express 2013 for Web](http://www.microsoft.com/visualstudio/eng/2013-downloads#d-2013-express) or [Visual Studio 2013](http://www.microsoft.com/visualstudio/eng/2013-downloads)
...
* To create a Windows virtual machine and install MongoDB, see [Install MongoDB on a virtual machine running Windows Server in Azure](../virtual-machines/virtual-machines-install-mongodb-windows-server.md).
...
2. In the **New Project** window, in the left pane, select **Visual C#**, and then select **Web**. In the middle pane, select **ASP.NET  Web Application**. At the bottom, name your project "MyTaskListApp," and then click **OK**.
...
4. If you aren't already signed into Microsoft Azure, you will be prompted to sign in. Follow the prompts to sign into Azure.
5. Once you are signed in, you can start configuring your App Service web app. Specify the **Web App name**, **App Service plan**, **Resource group**, and **Region**, then click **Create**.
...
Replace `<vm-dns-name>` with the DNS name of the virtual machine running MongoDB you created in the [Create a virtual machine and install MongoDB](#virtualmachine) step of this tutorial.  To find the DNS name of your virtual machine, go to the Azure Portal, select **Virtual Machines**, and find **DNS Name**.
...
For more information on MongoDB connection strings, see [Connections](http://www.mongodb.org/display/DOCS/Connections).
...
For more information on developing C# applications against MongoDB, see [CSharp Language Center](http://docs.mongodb.org/ecosystem/drivers/csharp/). 
