...
1. In the upper left corner of the [Azure Portal](https://portal.azure.com), click **New** > **Web + Mobile** > **Web App**.
    ...
    ![New web app](./media/web-sites-hybrid-connection-get-started/B02NewWebsite.png)
...
4. To verify the site is live, you can click the **Browse** icon to display the default page.
    ...
    ![Click browse to see your web app](./media/web-sites-hybrid-connection-get-started/B05Browse.png)
   
    ![Default web app page](./media/web-sites-hybrid-connection-get-started/B06DefaultWebSitePage.png)
...
7. The Hybrid Connection Manager is downloaded and installed for you. 
    ...
    ![Installing](./media/web-sites-hybrid-connection-get-started/D08HCMInstalling.png)
