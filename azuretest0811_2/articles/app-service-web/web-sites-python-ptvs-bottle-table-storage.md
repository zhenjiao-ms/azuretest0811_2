...
2. The project templates from the [Python Tools 2.2 for Visual Studio Samples VSIX](http://go.microsoft.com/fwlink/?LinkId=624025) are available under **Python**, **Samples**. Select **Polls Bottle Web Project** and click OK to create the project.
