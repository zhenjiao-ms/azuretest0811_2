...
![SQL Server Endpoint](./media/app-service-app-service-environment-securely-connecting-to-backend-resources/SqlServerEndpoint01.png)

There are two approaches for restricting traffic to this endpoint:

* [Network Access Control Lists](https://azure.microsoft.com/documentation/articles/virtual-networks-acl/) (Network ACLs)
...
![Network Access Control List Example](./media/app-service-app-service-environment-securely-connecting-to-backend-resources/NetworkAcl01.png)
...
![Default Network Security Rules](./media/app-service-app-service-environment-securely-connecting-to-backend-resources/DefaultNetworkSecurityRules01.png)
...
For details around controlling inbound traffic to your App Service Environment, see [Controlling inbound traffic to an App Service Environment](http://azure.microsoft.com/documentation/articles/app-service-app-service-environment-control-inbound-traffic/)
