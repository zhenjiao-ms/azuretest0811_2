---
title: Create a Node.js web app in Azure App Service | Microsoft Azure
...
![A browser displaying the 'Hello World' message.](./media/web-sites-nodejs-develop-deploy-mac/helloazure.png)
...
3. Click **Web + Mobile**, and then click **Web app**.
    ...
    ![](./media/web-sites-nodejs-develop-deploy-mac/create-quick-website.png)
...
8. Click **Create**.
    ...
    ![](./media/web-sites-nodejs-develop-deploy-mac/create-quick-website2.png)
...
10. In the **Web app** blade, click the **Deployment** part.
    ...
    ![](./media/web-sites-nodejs-develop-deploy-mac/deployment-part.png)
11. In the **Continuous Deployment** blade, click **Choose Source**
12. Click **Local Git Repository**, and then click **OK**.
    
    ![](./media/web-sites-nodejs-develop-deploy-mac/setup_git_publishing.png)
13. Set up deployment credentials if you haven't already done so.
    ...
    ![](./media/web-sites-nodejs-develop-deploy-mac/deployment-credentials.png)
...
14. In the Web app blade, click **Settings**, and then click **Properties**.
    ...
    ![](./media/web-sites-nodejs-develop-deploy-mac/git-url.png)
...
5. Open your web browser and navigate to http://localhost:1337. 
    ...
    ![A browser displaying the 'Hello World' message.](./media/web-sites-nodejs-develop-deploy-mac/helloworldlocal.png)
...
4. Refresh the browser window that you navigated to the web app's URL.
    ...
    ![A web page displaying 'Hello Azure'](./media/web-sites-nodejs-develop-deploy-mac/helloazure.png)
