...
This topic explains how to configure a web app using the [Azure Portal](https://portal.azure.com/).
...
![Application Settings](./media/web-sites-configure/configure01.png)
...
![Set deployment credentials](./media/web-sites-configure/configure03.png)
...
![FTP deployment credentials](./media/web-sites-configure/configure02.png)
...
For more information, see [How to: Monitor web endpoint status](http://go.microsoft.com/fwLink/?LinkID=279906).
