...
3. Click your app, then click **Settings** > **Custom domains and SSL** > **Bring External Domains**.
4. Take note of the IP address to use later.
...
4. Add the FQDN of your custom domain to the list (e.g. **www.contoso.com**).
   ...
   > [!NOTE]
   > Azure will attempt to verify the domain name you use here, so be sure that it is the same domain name
   > for which you created a DNS record in [Step 2](#createdns). If you are sure that 
   > 
5. Click **Save**.
6. Once the new custom domain name is successfully configured, navigate to your custom domain name in a brows. You should
