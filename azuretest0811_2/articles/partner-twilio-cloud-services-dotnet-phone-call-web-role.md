---
title: How to make a phone call from Twilio (.NET) | Microsoft Azure
...
1. Acquire a Twilio account and authentication token. To get started with Twilio, sign up at [https://www.twilio.com/try-twilio](http://www.twilio.com/try-twilio). You can evaluate pricing at [http://www.twilio.com/pricing](http://www.twilio.com/pricing). For information about the API provided by Twilio, see [http://www.twilio.com/voice/api](http://www.twilio.com/voice/api).
...
More information about TwiML can be found at [http://www.twilio.com/docs/api/twiml](http://www.twilio.com/docs/api/twiml). More information about &lt;Say&gt; and other Twilio verbs can be found at [http://www.twilio.com/docs/api/twiml/say](http://www.twilio.com/docs/api/twiml/say).
...
* Instead of using a web form, you could use Azure Blob storage or an Azure SQL Database instance to store phone numbers and call text. For information about using blobs in Azure, see [How to use the Azure Blob storage service in .NET](https://www.windowsazure.com/develop/net/how-to-guides/blob-storage/). For information about using SQL Database, see [How to use Azure SQL Database in .NET applications](https://www.windowsazure.com/develop/net/how-to-guides/sql-database/).
* You could use RoleEnvironment.getConfigurationSettings to retrieve the Twilio account ID and authentication token from your deployment's configuration settings, instead of hard-coding the values in your form. For information about the RoleEnvironment class, see [Microsoft.WindowsAzure.ServiceRuntime Namespace](http://msdn.microsoft.com/library/windowsazure/microsoft.windowsazure.serviceruntime.aspx).
* Read the Twilio security guidelines at [https://www.twilio.com/docs/security](http://www.twilio.com/docs/security).
* Learn more about Twilio at [https://www.twilio.com/docs](http://www.twilio.com/docs).
