---
title: Create an IoT Hub using the REST API | Microsoft Azure
...
Use the [IoT Hub REST API](https://msdn.microsoft.com/library/mt589014.aspx) to create a new IoT hub in your resource group. You can also use the REST API to make changes to an existing IoT hub.
