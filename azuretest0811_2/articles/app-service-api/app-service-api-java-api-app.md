...
This tutorial shows how to create a Java application and deploy it to Azure App Service API Apps using [Git](http://www.git-scm.com/). The instructions in this tutorial can be followed on any operating system that is capable of running Java. The code in this tutorial is built using [Maven](https://maven.apache.org/). [Jax-RS](https://jax-rs-spec.java.net/) is used to create the RESTful Service, and is generated based on the [Swagger](http://swagger.io/) metadata specification using the [Swagger Editor](http://editor.swagger.io/).

## Prerequisites
1. [Java Developer's Kit 8](or later.md)
2. [Maven](https://maven.apache.org/) installed on your development machine
3. [Git](http://www.git-scm.com/) installed on your development machine
4. A paid or [free trial](https://azure.microsoft.com/pricing/free-trial/) subscription to [Microsoft Azure](https://azure.microsoft.com/)
5. An HTTP test application like [Postman](https://www.getpostman.com/)
...
2. Navigate to the [Online Swagger Editor](http://editor.swagger.io/). Once there, click the **File -> Paste JSON** menu item.
    ...
    ![Paste JSON menu item](./media/app-service-api-java-api-app/paste-json.png)
3. Paste in the Contacts List API Swagger JSON you copied earlier. 
   
    ![Pasting JSON code into Swagger](./media/app-service-api-java-api-app/pasted-swagger.png)
...
1. Open the *Contact.java* model file, which is located in the *src/gen/java/io/swagger/model* folder, using [Visual Studio Code](https://code.visualstudio.com) or your favorite text editor. 
...
3. Open the *ContactsApiServiceImpl.java* service implementation file, which is located in the *src/main/java/io/swagger/api/impl* folder, using [Visual Studio Code](https://code.visualstudio.com) or your favorite text editor.
...
8. Use [Postman](https://www.getpostman.com/) to make a request to the "get all contacts" API method at http://localhost:8080/api/contacts.
...
1. Create a new API app in the [Azure portal](https://portal.azure.com/), by clicking the **New -> Web + Mobile -> API app** menu item, entering your app details, and then clicking **Create**.
...
5. Copy the new Git repository's URL to your clipboard. Save this as it will be important in a moment. 
    ...
    ![Set up a new Git repository for your app](./media/app-service-api-java-api-app/copy-git-repo-url.png)
