---
title: Replicate Hyper-V virtual machines in VMM clouds using Azure Site Recovery and PowerShell | Microsoft Azure
...
1. After the job has finished processing, run the following command:
...
1. Enable the DR for the VM by running the following command:
...
1. Fill in the data in the template:
