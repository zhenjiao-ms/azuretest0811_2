---
title: Restrict access to your Azure CDN content by country | Microsoft Azure
...
> [!NOTE]
> Once the configuration is set up, it will apply to all **Azure CDN from Verizon** endpoints in this Azure CDN profile.
> 
> 
