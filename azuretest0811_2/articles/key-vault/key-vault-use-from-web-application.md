---
title: Use Azure Key Vault from a Web Application | Microsoft Azure
...
![Application Settings displayed in Azure Portal](./media/key-vault-use-from-web-application/PortalAppSettings.png)
...
![Adding a Certificate to a Web App in the Azure Portal](./media/key-vault-use-from-web-application/PortalAddCertificate.png)
