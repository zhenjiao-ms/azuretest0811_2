...
* Overview: [http://msdn.microsoft.com/library/vstudio/ee382825(v=vs.100).aspx](http://msdn.microsoft.com/library/vstudio/ee382825\(v=vs.100\).aspx)

[OverviewLink]:http://msdn.microsoft.com/library/vstudio/ee382825(v=vs.100).aspx
* Preview: [http://msdn.microsoft.com/library/aa697428(v=vs.80).aspx](http://msdn.microsoft.com/library/aa697428\(v=vs.80\).aspx)

[PreviewLink]:http://msdn.microsoft.com/library/aa697428(v=vs.80).aspx
* Data types: [http://msdn.microsoft.com/library/bb399548(v=VS.100).aspx](http://msdn.microsoft.com/library/bb399548\(v=VS.100\).aspx)
