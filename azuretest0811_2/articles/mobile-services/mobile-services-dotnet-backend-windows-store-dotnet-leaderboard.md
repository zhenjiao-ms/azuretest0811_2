---
title: Creating a Windows Store leaderboard app with .NET Backend | Azure Mobile Services
...
![](./media/mobile-services-dotnet-backend-windows-store-dotnet-leaderboard/02leaderboard.png)
...
![](./media/mobile-services-dotnet-backend-windows-store-dotnet-leaderboard/03leaderboard.png)
...
![](./media/mobile-services-dotnet-backend-windows-store-dotnet-leaderboard/04leaderboard.png)

The project template includes an example controller and data object.

![](./media/mobile-services-dotnet-backend-windows-store-dotnet-leaderboard/05leaderboard.png)
...
![](./media/mobile-services-dotnet-backend-windows-store-dotnet-leaderboard/06leaderboard.png)
...
![](./media/mobile-services-dotnet-backend-windows-store-dotnet-leaderboard/07leaderboard.png)
...
![](./media/mobile-services-dotnet-backend-windows-store-dotnet-leaderboard/08leaderboard.png)
...
![](./media/mobile-services-dotnet-backend-windows-store-dotnet-leaderboard/10leaderboard.png)
...
![](./media/mobile-services-dotnet-backend-windows-store-dotnet-leaderboard/11leaderboard.png)
...
![](./media/mobile-services-dotnet-backend-windows-store-dotnet-leaderboard/12leaderboard.png)

In the **Publish** dialog, click **Azure Mobile Services**.

![](./media/mobile-services-dotnet-backend-windows-store-dotnet-leaderboard/13leaderboard.png)

If you are not signed into your Azure account already, click **Sign In**.

![](./media/mobile-services-dotnet-backend-windows-store-dotnet-leaderboard/14leaderboard.png)

Select an existing Mobile Service, or click **New** to create a new one. Then click **OK** to publish.

![](./media/mobile-services-dotnet-backend-windows-store-dotnet-leaderboard/15leaderboard.png)
...
![](./media/mobile-services-dotnet-backend-windows-store-dotnet-leaderboard/16leaderboard.png)

In the **Manage Access Keys** dialog, copy the value for the application key.

![](./media/mobile-services-dotnet-backend-windows-store-dotnet-leaderboard/17leaderboard.png)
...
* [Add push notifications](../notification-hubs-windows-store-dotnet-get-started.md); for example, when someone adds a new player or updates a score.
