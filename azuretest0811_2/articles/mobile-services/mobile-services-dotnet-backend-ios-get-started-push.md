---
title: Add Push Notifications to App (iOS) | .NET Backend
...
This topic shows you how to add push notifications to the [quickstart project](mobile-services-dotnet-backend-ios-get-started.md), so that your mobile service sends a push notification each time a record is inserted. You must complete [Get Started with Mobile Services](mobile-services-dotnet-backend-ios-get-started.md) first.
