---
title: Get Started with authentication in Mobile Services for Xamarin Android apps | Microsoft Azure
...
This tutorial is based on the Mobile Services quickstart. You must also first complete the tutorial [Get started with Mobile Services](mobile-services-dotnet-backend-xamarin-android-get-started.md).
