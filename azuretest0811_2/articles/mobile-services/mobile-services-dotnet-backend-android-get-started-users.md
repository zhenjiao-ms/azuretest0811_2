---
title: Get started with authentication (Android) | Microsoft Azure
...
1. Open the project that you created when you completed the tutorial [Get started with Mobile Services](mobile-services-dotnet-backend-android-get-started.md).
2. From the **Run** menu, then click **Run app** to start the app; verify that an unhandled exception with a status code of 401 (Unauthorized) is raised after the app starts.
