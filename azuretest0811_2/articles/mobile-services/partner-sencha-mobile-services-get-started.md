---
title: Get Started with Azure Mobile Services and Sencha
...
3. Click **Create TodoItems table** to create a table to store app data.
   ...
   > [!NOTE]
   > Do NOT download the HTML app from the Azure classic portal. Instead, we will manually create a Sencha Touch application in the section below.
   > 
   > 
4. Take note of the **appKey** and **appUrl** in the Azure classic portal. You will use them in other sections of this tutorial.
...
> [!NOTE]
> You can only use this method when you have generated your application using the <code>sencha generate app</code> command.
> 
> 
