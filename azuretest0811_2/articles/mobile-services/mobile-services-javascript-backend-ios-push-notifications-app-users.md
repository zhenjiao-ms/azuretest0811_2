---
title: Send Push Notifications to Authenticated Users in iOS (JavaScript backend)
...
In this topic, you learn how to send push notifications to an authenticated user on iOS. Before starting this tutorial, complete [Get started with authentication](mobile-services-ios-get-started-users.md) and [Get started with push notifications](mobile-services-javascript-backend-ios-get-started-push.md) first.
