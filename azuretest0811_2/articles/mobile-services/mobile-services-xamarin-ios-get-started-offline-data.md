---
title: Using offline data in Mobile Services (Xamarin iOS) | Microsoft Azure
...
1. [Review the Mobile Services sync code](#review-offline)
2. [Update the sync behavior of the app](#update-sync)
3. [Update the app to reconnect your mobile service](#update-online-app)
