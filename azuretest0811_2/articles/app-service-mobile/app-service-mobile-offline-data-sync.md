---
title: Offline Data Sync in Azure Mobile Apps | Microsoft Azure
...
extension. For more details, see [Windows 8.1: Enable offline sync](app-service-mobile-windows-store-dotnet-get-started-offline-data.md). Android and iOS ship with a version of
...
`IMobileServicesSyncContext.InitializeAsync(localstore)` in the [.NET client SDK](app-service-mobile-dotnet-how-to-use-client-library.md).
