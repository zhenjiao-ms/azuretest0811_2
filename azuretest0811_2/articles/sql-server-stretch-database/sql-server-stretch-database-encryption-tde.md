---
title: Enable Transparent Data Encryption (TDE) for SQL Server Stretch Database on Azure | Microsoft Azure
...
3. Select the **Transparent data encryption** option
   ![](./media/sql-server-stretch-database-encryption-tde/stretchtde1.png)
4. Select the **On** setting, and then select **Save**
   ![](./media/sql-server-stretch-database-encryption-tde/stretchtde2.png)
