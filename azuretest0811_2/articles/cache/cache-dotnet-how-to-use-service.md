...
A subscription is chosen by default and is displayed. To change the subscription, invoke the [Select-AzureSubscription](http://msdn.microsoft.com/library/dn495203.aspx) cmdlet.
