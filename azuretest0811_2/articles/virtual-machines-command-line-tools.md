---
title: Azure CLI commands in Service Management mode | Microsoft Azure
...
[!INCLUDE [learn-about-deployment-models](../includes/learn-about-deployment-models-classic-include.md)] You can also [read about all the Resource Manager model commands](virtual-machines/azure-cli-arm-commands.md).
...
> [!NOTE]
> The CLI's Azure Resource Manager mode and asm mode are mutually exclusive. That is, resources created in one mode cannot be managed from the other mode.
> 
> 
