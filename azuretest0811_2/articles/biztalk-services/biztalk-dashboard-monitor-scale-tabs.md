---
title: Dashboard, Monitor, Scale, Configure, and Hybrid Connections in BizTalk Services | Microsoft Azure
...
## Quick Start (![Quick Start](./media/biztalk-dashboard-monitor-scale-tabs/QuickStartIcon.png))
