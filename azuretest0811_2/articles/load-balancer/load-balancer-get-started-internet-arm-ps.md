...
> [!IMPORTANT]
> The load balancer will use the domain label of the public IP as prefix for its FQDN. This is a change from classic deployment model which uses the cloud service as the load balancer FQDN. 
