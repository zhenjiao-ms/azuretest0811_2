---
title: 'Get started configuring an internet facing load balancer using Azure Resource Manager | Microsoft Azure '
...
> [!NOTE]
> The public IP address domain name label property will be the prefix for the FQDN of the load balancer.
> 
> 
