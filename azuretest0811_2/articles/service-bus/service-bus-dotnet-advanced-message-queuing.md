---
title: How to use AMQP 1.0 with the .NET Service Bus API | Microsoft Azure
...
Where `[namespace]` and `[SAS key]` are obtained from the [Azure classic portal](https://manage.windowsazure.com). For more information, see [How to use Service Bus queues][].
