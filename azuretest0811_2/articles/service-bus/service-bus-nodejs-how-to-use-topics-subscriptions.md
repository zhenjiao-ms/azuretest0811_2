---
title: How to use Service Bus topics with Node.js | Microsoft Azure
...
Create a blank Node.js application. For instructions on creating a Node.js application, see [Create and deploy a Node.js application to an Azure Web Site], [Node.js Cloud Service][Node.js Cloud Service](using Windows PowerShell.md), or Web Site with WebMatrix.
