...
### Standard properties
The following tables show the mapping between the Proton-Python standard message properties and the [BrokeredMessage](https://msdn.microsoft.com/library/azure/microsoft.servicebus.messaging.brokeredmessage.aspx) standard message properties.
