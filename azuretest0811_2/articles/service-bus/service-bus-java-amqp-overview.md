...
![](./media/service-bus-java-amqp-overview/Example1.png)
...
For more information about how to obtain and use these libraries with Service Bus, see the [Service Bus AMQP Developer's Guide](service-bus-amqp-dotnet.md). See the [Next steps](service-bus-java-amqp-overview.md#next-steps) section for links to further information.
