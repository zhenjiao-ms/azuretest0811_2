---
title: Create a Service Bus namespace with queue using an Azure Resource Manager template | Microsoft Azure
...
For more information about creating templates, please see [Authoring Azure Resource Manager templates](../resource-group-authoring-templates.md).

For the complete template, see the [Service Bus namespace and queue template](https://github.com/Azure/azure-quickstart-templates/blob/master/201-servicebus-create-queue/) on GitHub.
...
> 
> To check for the latest templates, visit the [Azure Quickstart Templates](https://azure.microsoft.com/documentation/templates/?term=service+bus) gallery and search for Service Bus.
> 
> 
