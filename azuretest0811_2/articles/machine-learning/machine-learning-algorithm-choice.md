---
title: How to choose machine learning algorithms | Microsoft Azure
...
![Non-linear class bounday](./media/machine-learning-algorithm-choice/image1.png)

***Non-linear class boundary*** *- relying on a linear classification
algorithm would result in low accuracy*

![Data with a nonlinear trend](./media/machine-learning-algorithm-choice/image2.png)
...
![Data with a linear trend](./media/machine-learning-algorithm-choice/image3.png)
...
![Logistic regression to two-class data with just one feature](./media/machine-learning-algorithm-choice/image4.png)
...
![Decision tree subdivides a feature space](./media/machine-learning-algorithm-choice/image5.png)
...
## ![Boundaries learned by neural networks](./media/machine-learning-algorithm-choice/image6.png)
...
![Support vector machine class boundary](./media/machine-learning-algorithm-choice/image7.png)
...
![PCA-based anomaly detection](./media/machine-learning-algorithm-choice/image8.png)
...
![Data set grouped using K-means](./media/machine-learning-algorithm-choice/image9.png)
...
![Two-class classifiers combined to form a three-class classifier](./media/machine-learning-algorithm-choice/image10.png)
