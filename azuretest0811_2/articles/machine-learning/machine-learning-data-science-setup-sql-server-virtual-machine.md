...
3. On the **Create a Virtual Machine** page, select a virtual machine
   ...
   ![Select SQL Server VM](./media/machine-learning-data-science-setup-sql-server-virtual-machine/selectsqlvmimg.png)
4. On the first **Virtual Machine Configuration** page, provide the
   ...
   * Select the appropriate **SIZE** from the drop down list.
   ...
   ![VM Configuration](./media/machine-learning-data-science-setup-sql-server-virtual-machine/4vm-config.png)
...
7. Your SQL Server VM can also serve as an IPython Notebook Server, which will be configured in a later step.
   ...
   ![Select MSSQL and IPython ports](./media/machine-learning-data-science-setup-sql-server-virtual-machine/sqlvmports.png)
8. Accept the default **Install VM agent** option checked and click the the check mark in the bottom right
   ...
   `![VM Final Options](./media/machine-learning-data-science-setup-sql-server-virtual-machine/vmpostopts.png)
...
1. While connected to the virtual machine by using Remote Desktop, use the Windows **Search** pane and type **SQL Server Management Studio** (SMSS). Click to start the SQL Server Management Studio (SSMS). You may want to add a shortcut to SSMS on your Desktop for future use.
   ...
   ![Start SSMS](./media/machine-learning-data-science-setup-sql-server-virtual-machine/searchssms.png)
...
2. When opening, Management Studio presents the **Connect to Server**
   ...
   ***your\_VM\_name*\\your\_local\_administrator** in the **User
   ...
   ![Connect to Server](./media/machine-learning-data-science-setup-sql-server-virtual-machine/19connect-to-server.png)
   
   <br>
   
   > [!TIP]
   > You may change the SQL Server authentication mode using a Windows registry key change or using the SQL Server Management Studio. To change authentication mode using the registry key change, start a **New Query** and execute the following script:
   > 
   > 
...
1. In **SQL Server Management Studio Object Explorer**, right-click the
   name of the instance of SQL Server (the virtual machine name), and
   then click **Properties**.
   
   ![Server Properties](./media/machine-learning-data-science-setup-sql-server-virtual-machine/20server-properties.png)
2. On the **Security** page, under **Server authentication**, select
   **SQL Server and Windows Authentication mode**, and then click
   **OK**.
   
   ![Select Authentication Mode](./media/machine-learning-data-science-setup-sql-server-virtual-machine/21mixed-mode.png)
3. In the **SQL Server Management Studio** dialog box, click **OK** to
   acknowledge the requirement to restart SQL Server.
4. In **Object Explorer**, right-click your server, and then click
   **Restart**. (If SQL Server Agent is running, it must also be
   restarted.)
   
   ![Restart](./media/machine-learning-data-science-setup-sql-server-virtual-machine/22restart2.png)
5. In the **SQL Server Management Studio** dialog box, click **Yes** to
...
2. Right-click the **Security** folder, point to **New**, and select
   **Login…**.
   ...
   ![New Login](./media/machine-learning-data-science-setup-sql-server-virtual-machine/23new-login.png)
...
10. In the **Default language** list, leave **default** as the value.
    ...
    ![Login Properties](./media/machine-learning-data-science-setup-sql-server-virtual-machine/24test-login.png)
11. If this is the first login you are creating, you may want to
    ...
    **Security Note:** Members of the sysadmin fixed server role have
    ...
    ![sysadmin](./media/machine-learning-data-science-setup-sql-server-virtual-machine/25sysadmin.png)
12. Click OK.
...
4. Enter the sql user's password in the **Server user account password** text box.
   ...
   ![Azure ML Import Data](./media/machine-learning-data-science-setup-sql-server-virtual-machine/amlreader.png)
...
![VM Shutdown](./media/machine-learning-data-science-setup-sql-server-virtual-machine/vmshutdown.png)
