---
title: Extend your experiment with R | Microsoft Azure
...
You can extend the functionality of ML Studio through the R language by using the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module.

This module accepts multiple input datasets and it yields a single dataset as output. You can type an R script into the **R Script** parameter of the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module.
...
The list of installed packages can change. To get the complete, current list of installed packages, including the description of each package, enter the following code into the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module:

    out <- data.frame(installed.packages(,,,fields="Description"))
    maml.mapOutputPort("out")

This sends the list of packages to the output port of the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module.
To view the package list, connect a conversion module such as [Convert to CSV](https://msdn.microsoft.com/library/azure/faa6ba63-383c-4086-ba58-7abf26b85814/) to the left output of the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module, run the experiment, then click the output of the conversion module and select **Download**. 
...
## Importing packages
You also can import packages that are not already installed from a staged ML Studio repository by using the following commands in the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module and zipped package archive:
