---
title: Set up a virtual machine as an IPython Notebook server | Microsoft Azure
...
1. Log in to <a href="https://manage.windowsazure.com" target="_blank">Azure Classic Portal</a>, and click **New** in the bottom left corner. A window will pop up. Select **COMPUTE** -> **VIRTUAL MACHINE** -> **FROM GALLERY**.
    ...
    ![Create workspace](./media/machine-learning-data-science-setup-virtual-machine/create-virtual-machine-1.png)
2. Choose one of the following images:
   ...
   * Windows Server Essentials Experience (Windows Server 2012 R2)
     ...
     ![Create workspace](./media/machine-learning-data-science-setup-virtual-machine/create-virtual-machine-2.png)
3. Enter a name for the virtual machine you want to create, select the size of the machine (Default: A3) based on the size of the data the machine is going to process and how powerful you want the machine to be (memory size and the number of compute cores), enter a user name and password for the machine. Then, click the arrow pointing right to go to the next configuration page.
    ...
    ![Create workspace](./media/machine-learning-data-science-setup-virtual-machine/create-virtual-machine-3.png)
4. Select the **REGION/AFFINITY GROUP/VIRTUAL NETWORK** that contains the **STORAGE ACCOUNT** that you are planning to use for this virtual machine, and then select that storage account. Add an endpoint at the bottom in the **ENDPOINTS**  field by entering the name of the endpoint ("IPython" here). You can choose any string as the **NAME** of the end point, and any integer between 0 and 65536 that is **available** as the **PUBLIC PORT**. The **PRIVATE PORT** has to be **9999**. Users should **avoid** using public ports that have already been assigned for internet services. <a href="http://www.chebucto.ns.ca/~rakerman/port-table.html" target="_blank">Ports for Internet Services</a> provides a list of ports that have been assigned and should be avoided.
    ...
    ![Create workspace](./media/machine-learning-data-science-setup-virtual-machine/create-virtual-machine-4.png)
5. Click the check mark to start the virtual machine provisioning process.
   
    ![Create workspace](./media/machine-learning-data-science-setup-virtual-machine/create-virtual-machine-5.png)
...
![Create workspace](./media/machine-learning-data-science-setup-virtual-machine/create-virtual-machine-6.png)
...
![Create workspace](./media/machine-learning-data-science-setup-virtual-machine/add-endpoints-after-creation.png)
...
![Create workspace](./media/machine-learning-data-science-setup-virtual-machine/dns-name-and-host-name.png)
...
Internet Explorer:
![Create workspace](./media/machine-learning-data-science-setup-virtual-machine/browser-warning-ie.png)

Chrome:
![Create workspace](./media/machine-learning-data-science-setup-virtual-machine/browser-warning.png)
...
![Create workspace](./media/machine-learning-data-science-setup-virtual-machine/sample-ipnbs.png)
...
![Create workspace](./media/machine-learning-data-science-setup-virtual-machine/upload-ipnb-1.png)

![Create workspace](./media/machine-learning-data-science-setup-virtual-machine/upload-ipnb-2.png)
...
![VM Shutdown](./media/machine-learning-data-science-setup-virtual-machine/vmshutdown.png)
