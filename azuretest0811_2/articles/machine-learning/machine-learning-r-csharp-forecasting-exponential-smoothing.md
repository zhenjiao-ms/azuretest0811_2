---
title: Forecasting-Exponential Smoothing | Microsoft Azure
...
From within Azure Machine Learning, a new blank experiment was created. Sample input data was uploaded with a predefined data schema. Linked to the data schema is an [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module that generates the ETS forecasting model by using ‘ets’ and ‘forecast’ functions from R. 

![Experiment flow](./media/machine-learning-r-csharp-forecasting-exponential-smoothing/ets-img2.png)

#### Module 1:
    # Add in the CSV file with the data in the format shown below 
![Data sample](./media/machine-learning-r-csharp-forecasting-exponential-smoothing/ets-img3.png)    
