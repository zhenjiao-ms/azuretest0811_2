---
title: 'The Team Data Science Process in action: using SQL Data Warehouse | Microsoft Azure'
...
![](./media/machine-learning-data-science-process-sqldw-walkthrough/ps_download_scripts.png)
...
![Plot #21](./media/machine-learning-data-science-process-sqldw-walkthrough/azcopy-overwrite.png)
...
![](./media/machine-learning-data-science-process-sqldw-walkthrough/ps_load_data.png)
...
2. Persist the sampled and engineered data you plan to use for model building in a new SQL DW table and use the new table in the [Import Data](https://msdn.microsoft.com/library/azure/4e1b0fe6-aded-4b3f-a36f-39b8862b9004/) module in Azure Machine Learning. The PowerShell script in earlier step has done this for you. You can read directly from this table in the Import Data module.
...
1. Log in to your AzureML workspace, click "Studio" at the top, and click "NOTEBOOKS" on the left side of the web page.
    ...
    ![Plot #22](./media/machine-learning-data-science-process-sqldw-walkthrough/ipnb-service-aml-1.png)
2. Click "NEW" on the left bottom corner of the web page, and select "Python 2". Then, provide a name to the notebook and click the check mark to create the new blank IPython Notebook.
    ...
    ![Plot #23](./media/machine-learning-data-science-process-sqldw-walkthrough/ipnb-service-aml-2.png)
3. Click the "Jupyter" symbol on the left top corner of the new IPython Notebook.
   
    ![Plot #24](./media/machine-learning-data-science-process-sqldw-walkthrough/ipnb-service-aml-3.png)
4. Drag and drop the sample IPython Notebook to the **tree** page of your AzureML IPython Notebook service, and click **Upload**. Then, the sample IPython Notebook will be uploaded to the AzureML IPython Notebook service.
    ...
    ![Plot #25](./media/machine-learning-data-science-process-sqldw-walkthrough/ipnb-service-aml-4.png)
...
![Plot #1](./media/machine-learning-data-science-process-sqldw-walkthrough/sql-walkthrough_26_1.png)
...
![Plot #2](./media/machine-learning-data-science-process-sqldw-walkthrough/sql-walkthrough_28_1.png)
...
![Plot #3](./media/machine-learning-data-science-process-sqldw-walkthrough/sql-walkthrough_35_1.png)

and

    pd.Series(trip_dist_bin_id).value_counts().plot(kind='line')

![Plot #4](./media/machine-learning-data-science-process-sqldw-walkthrough/sql-walkthrough_36_1.png)
...
![Plot #6](./media/machine-learning-data-science-process-sqldw-walkthrough/sql-walkthrough_42_1.png)

Similarly we can check the relationship between **rate\_code** and **trip\_distance**.

    plt.scatter(df1['passenger_count'], df1['trip_distance'])

![Plot #8](./media/machine-learning-data-science-process-sqldw-walkthrough/sql-walkthrough_46_1.png)
...
![Plot #26](./media/machine-learning-data-science-process-sqldw-walkthrough/tip_class_hist_1.png)
...
1. Get the data into Azure ML using the [Import Data](https://msdn.microsoft.com/library/azure/4e1b0fe6-aded-4b3f-a36f-39b8862b9004/) module, available in the **Data Input and Output** section. For more information, see the [Import Data](https://msdn.microsoft.com/library/azure/4e1b0fe6-aded-4b3f-a36f-39b8862b9004/) module reference page.
   
    ![Azure ML Import Data](./media/machine-learning-data-science-process-sqldw-walkthrough/amlreader.png)
...
![Azure ML Train](./media/machine-learning-data-science-process-sqldw-walkthrough/azuremltrain.png)
...
![Azure Scoring](./media/machine-learning-data-science-process-sqldw-walkthrough/amlscoring.png)
...
![Azure ML Publish](./media/machine-learning-data-science-process-sqldw-walkthrough/azuremlpublish.png)
