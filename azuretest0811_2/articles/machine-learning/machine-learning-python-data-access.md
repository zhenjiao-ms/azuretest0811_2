---
title: Access datasets with Machine Learning Python client library | Microsoft Azure
...
1. Ask to be promoted to role of owner.  To do this, a current owner of the workspace needs to first remove you from the workspace then re-invite you to it as an owner.
...
4. Select the code snippet from the window that appears and copy it to your clipboard.
    ...
    ![Access Code](./media/machine-learning-python-data-access/dataset-access-code.png)
5. Paste the code into the notebook of you local Python application.
   
    ![Notebook](./media/machine-learning-python-data-access/ipython-dataset.png)
...
Some of the modules, such as the [Split](https://msdn.microsoft.com/library/azure/70530644-c97a-4ab6-85f7-88bf30a8be5f/) module, output to a format named `Dataset`, which is not supported by the Python client library.

![Dataset Format](./media/machine-learning-python-data-access/dataset-format.png)

You'll need to use a conversion module, such as [Convert to CSV](https://msdn.microsoft.com/library/azure/faa6ba63-383c-4086-ba58-7abf26b85814/), to get an output into a supported format.

![GenericCSV Format](./media/machine-learning-python-data-access/csv-format.png)
...
3. Insert a [Split](https://msdn.microsoft.com/library/azure/70530644-c97a-4ab6-85f7-88bf30a8be5f/) module, and connect its input to the dataset module output.
4. Insert a [Convert to CSV](https://msdn.microsoft.com/library/azure/faa6ba63-383c-4086-ba58-7abf26b85814/) module and connect its input to one of the [Split](https://msdn.microsoft.com/library/azure/70530644-c97a-4ab6-85f7-88bf30a8be5f/) module outputs.
5. Save the experiment, run it, and wait for it to finish running.
6. Click on the output node on the [Convert to CSV](https://msdn.microsoft.com/library/azure/faa6ba63-383c-4086-ba58-7abf26b85814/) module.
7. A context menu will appear, select **Generate Data Access Code**.
   
    ![Context Menu](./media/machine-learning-python-data-access/experiment.png)
8. A window will appear. Select the code snippet and copy it to your clipboard.
   
    ![Access Code](./media/machine-learning-python-data-access/intermediate-dataset-access-code.png)
9. Paste the code in your notebook.
   
    ![Notebook](./media/machine-learning-python-data-access/ipython-intermediate-dataset.png)
10. You can visualize the data using matplotlib. This displays in a histogram for the age column:
    
    ![Histogram](./media/machine-learning-python-data-access/ipython-histogram.png)
