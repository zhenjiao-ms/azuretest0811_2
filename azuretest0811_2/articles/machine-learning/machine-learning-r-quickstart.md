---
title: Quickstart tutorial for R language for Machine Learning | Microsoft Azure
...
The data used in this article, along with R scripts, can be [downloaded here](https://azurebigdatatutorials.blob.core.windows.net/rquickstart/RFiles.zip). This data was originally synthesized from information available from the University of Wisconsin at http://future.aae.wisc.edu/tab/production.html.
...
I will use RStudio to develop, test and debug R code on a small scale. This code is then cut and paste into an [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module in Machine Learning Studio ready to run.  

### The Execute R Script module
Within Machine Learning Studio, R scripts are run within the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module. An example of the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module in Machine Learning Studio is shown in Figure 1.

 ![R programming language: The Execute R Script module selected in Machine Learning Studio](./media/machine-learning-r-quickstart/fig1.png)

*Figure 1. The Machine Learning Studio environment showing the Execute R Script module selected.*

Referring to Figure 1, let's look at some of the key parts of the Machine Learning Studio environment for working with the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module.
...
* The lower part of right pane shows some properties of the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/). You can view the error and output logs by clicking on the appropriate spots of this pane.

We will, of course, be discussing the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) in greater detail in the rest of this document.

When working with complex R functions, I recommend that you edit, test and debug in RStudio. As with any software development, extend your code incrementally and test it on small simple test cases. Then cut and paste your functions into the R script window of the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module. This approach allows you to harness both the RStudio integrated development environment (IDE) and the power of Azure Machine Learning.  

#### Execute R code
Any R code in the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module will execute when you run the experiment by clicking on the **Run** button. When execution has completed, a check mark will appear on the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) icon.
...
To reiterate, I recommend you test and debug your R code on a small scale in RStudio. However, there are cases where you will need to track down R code problems in the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) itself. In addition, it is good practice to check your results in Machine Learning Studio.
...
If an error occurs in Machine Learning Studio while running your R code, your first course of action should be to look at error.log. This file can contain useful error messages to help you understand and correct your error. To view error.log, click on **View error log** on the **properties pane** for the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) containing the error.

For example, I ran the following R code, with an undefined variable y, in an [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module:
...
This code fails to execute, resulting in an error condition. Clicking on **View error log** on the **properties pane** produces the display shown in Figure 2.
  ...
  ![Error message pop up](./media/machine-learning-r-quickstart/fig2.png)

*Figure 2. Error message pop-up.*

It looks like we need to look in output.log to see the R error message. Click on the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) and then click on the **View output.log** item on the **properties pane** to the right. A new browser window opens, and I see the following.
...
Azure Machine Learning comes with over 350 preinstalled R language packages. You can use the following code in the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module to retrieve a list of the preinstalled packages.
...
RStudio is a widely used IDE for R. I will use RStudio for editing, testing and debugging some of the R code used in this quick start guide. Once R code is tested and ready, you simply cut and paste from the RStudio editor into a Machine Learning Studio [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module.  
...
In this section we will discuss how you get data into and out of the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module. We will review how to handle various data types read into and out of the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module.
...
* In the **Search experiment items** box on the top of the left pane, type [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/). You will see the module appear in the search list.
* Drag and drop the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module onto your pallet.  
* Connect the output of the **csdairydata.csv dataset** to the leftmost input (**Dataset1**) of the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/).
* **Don't forget to click on 'Save'!**  

At this point your experiment should look something like Figure 3.

![The CA Dairy Analysis experiment with dataset and Execute R Script module](./media/machine-learning-r-quickstart/fig3.png)
...
![Summary of the cadairydata.csv dataset](./media/machine-learning-r-quickstart/fig4.png)
...
Let's have a look at the inputs to the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module. In this example we will read the California dairy data into the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module.  

There are three possible inputs for the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module. You may use any one or all of these inputs, depending on your application. It is also perfectly reasonable to use an R script that takes no input at all.  
...
#### Script Bundle
The Script Bundle input allows you to pass the contents of a zip file into [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module. You can use one of the following commands to read the contents of the zip file into your R code.
...
5. Connect the output of the **zip data** icon to the **Script Bundle** input of the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module.
6. Type the `source()` function with your zip file name into the code window for the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module. In my case I typed `source("src/simpleplot.R")`.  
7. Make sure you click **Save**.

Once these steps are complete, the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module will execute the R script in the zip file when the experiment is run. At this point your experiment should look something like Figure 5.

![Experiment using zipped R script](./media/machine-learning-r-quickstart/fig6.png)
...
Execute your experiment by clicking on the **Run** button. When the execution finishes, click on the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module and then click **View output log** on the properties pane. A new page should appear in your browser showing the contents of the output.log file. When you scroll down you should see something like the following.
...
> [!NOTE]
> This same printed output is conveniently available from the R Device output of the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module. We will discuss the outputs of the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module in the next section.  
> 
> 
...
![The visualization of the output of the California dairy data](./media/machine-learning-r-quickstart/fig7.png)
...
### R Device output
The Device output of the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module contains messages and graphics output. Both standard output and standard error messages from R are sent to the R Device output port.  
...
![Standard output and standard error from the R Device port](./media/machine-learning-r-quickstart/fig8.png)
...
![Graphics output from the R Device port](./media/machine-learning-r-quickstart/fig9.png)
...
Now that we can read the California dairy data into the R code in the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module, we need to ensure that the data in the columns has the intended type and format.  
...
I have deleted the line that created the scatterplot matrix and added a line converting the 'Month' column to a factor. In my experiment I will just cut and paste the R code into the code window of the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) Module. You could also update the zip file and upload it to Azure Machine Learning Studio, but this takes several steps.  
...
> [!NOTE]
> From now on in this section, I will just show you the additional code I am adding in the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module. I will add each new line **before** the `str()` function. I use this function to verify my results in Azure Machine Learning Studio.
> 
> 

I add the following line to my R code in the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module.
...
At this point our data is cleaned up and we are ready for some modeling. Looking at the visualization summary for the Result Dataset output of our [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module, you will see the 'Month' column is 'Categorical' with 12 unique values, again, just as we wanted.
...
Let's get started with our example. Drag and drop a **new** [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module into your experiment. Connect the Result Dataset1 output port of the existing [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module to the Dataset1 input port of the new [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module.
...
![Scatterplot matrix of selected variables](./media/machine-learning-r-quickstart/fig17.png)
...
![Pairwise scatterplot of de-trended and standardized time series](./media/machine-learning-r-quickstart/fig18.png)
...
Note that the row names are in a column of the dataframe. Doing so preserves the row names when they are output from the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/).
...
![Results output from the correlation analysis](./media/machine-learning-r-quickstart/fig20.png)
...
Start by adding a **new** [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module to your experiment. Connect the **Result Dataset** output of the existing [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module to the **Dataset1** input of the new module. The result should look something like Figure 20.

![The experiment with the new Execute R Script module added](./media/machine-learning-r-quickstart/fig21.png)
...
As a sanity test, let's make a time series plot of the California dairy production data with the trend curve shown. I have added the following code in the Azure Machine Learning [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) model (not RStudio) to create the model and make a plot. The result is shown in Figure 23.
...
Let's make another time series plot of the California dairy production data to see how well the seasonal model is working. I have added the following code in the Azure Machine Learning [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) to create the model and make a plot.
...
![Comparison of RMS errors for the models](./media/machine-learning-r-quickstart/fig26.png)
