---
title: Manage experiment iterations in Machine Learning Studio | Microsoft Azure
...
For example, suppose you create an experiment with the [Linear Regression](https://msdn.microsoft.com/library/azure/31960a6f-789b-4cf7-88d6-2e1152c0bd1a/) module and you want to observe the effect of changing the value of **Learning rate** on your experiment results. You run the experiment multiple times with different values for this parameter, as follows:
...
![Example run history](./media/machine-learning-manage-experiment-iterations/viewrunhistory.jpg)
