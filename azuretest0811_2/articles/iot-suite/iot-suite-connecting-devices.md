---
title: Connect a device using C on Windows | Microsoft Azure
...
6. In **Solution Explorer**, right-click on the **RMDevice** project and then click **Properties** to open the project's **Property Pages** dialog box. For details,see [Setting Visual C++ Project Properties](https://msdn.microsoft.com/library/669zx6zc.aspx). 
