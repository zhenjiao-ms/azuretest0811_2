---
title: Azure Data Catalog supported data sources | Microsoft Azure
...
> [!NOTE]
> "DSL Structure" column in the table below only lists connection properties for "address" property bag which are used by Azure Data Catalog (i.e. "address" property bag can contain other connection properties of the data source which Azure Data Catalog persists, but does not use.)
> 
> <table>
> <tr>
