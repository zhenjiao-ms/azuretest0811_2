---
title: Deploy a Node.js application using MongoDB | Microsoft Azure
...
> [!NOTE]
> Using Visual Studio, you can publish the application locally by debugging (F5) or using the publish wizard.
> 
> 
