---
title: Get started with Service Fabric Reliable Actors | Microsoft Azure
...
![Service Fabric tools for Visual Studio - new project](./media/service-fabric-reliable-actors-get-started/reliable-actors-newproject.PNG)

In the next dialog box, you can choose the type of project that you want to create.

![Service Fabric project templates](./media/service-fabric-reliable-actors-get-started/reliable-actors-newproject1.PNG)
...
![Service Fabric project structure](./media/service-fabric-reliable-actors-get-started/reliable-actors-projectstructure.PNG)
...
![Service Fabric debugging output window](./media/service-fabric-reliable-actors-get-started/debugging-output.PNG)
