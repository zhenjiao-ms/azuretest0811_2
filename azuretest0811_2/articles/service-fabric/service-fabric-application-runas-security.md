---
title: Understanding Service Fabric application RunAs security policies | Microsoft Azure
...
> [!NOTE]
> Domain accounts are supported on Windows Server deployments where Azure Active Directory is available.
> 
> 
...
![Visual Studio CopyToOutput for SetupEntryPoint batch file](./media/service-fabric-application-runas-security/copy-to-output.png)
