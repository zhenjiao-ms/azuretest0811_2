---
title: Delete a cluster and its’ resources | Microsoft Azure
...
![Resource Group Delete](./media/service-fabric-cluster-delete/ResourceGroupDelete.PNG)
...
5. Click on one of the **Tags** in the tags blade to get a list of all the resources with that tag.
    ...
    ![Resource Tags](./media/service-fabric-cluster-delete/ResourceTags.png)
6. Once you have the list of tagged resources, click on each of the resources and delete them.
   
    ![Tagged Resources](./media/service-fabric-cluster-delete/TaggedResources.PNG)
