---
title: Service Fabric project creation next steps | Microsoft Azure
...
### ASP.NET core
The Service Fabric SDK provides the same set of ASP.NET Core templates that are available for standalone ASP.NET Core projects: empty, [Web API](https://docs.asp.net/en/latest/tutorials/first-web-api.html), and [Web Application](https://docs.asp.net/en/latest/tutorials/first-mvc-app/index.html).
