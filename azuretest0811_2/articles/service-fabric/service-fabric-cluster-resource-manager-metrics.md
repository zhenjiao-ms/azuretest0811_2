---
title: Managing Metrics with the Azure Service Fabric Cluster Resource Manager | Microsoft Azure
...
![Cluster Layout with Default Metrics](./media/service-fabric-cluster-resource-manager-metrics/cluster-resource-manager-cluster-layout-with-default-metrics.png)
...
![Cluster Balanced with both Default and Custom metrics](./media/service-fabric-cluster-resource-manager-metrics/Service-Fabric-Resource-Manager-Dynamic-Load-Reports.png)
...
![Metric Weight Example and Its Impact on Balancing Solutions](./media/service-fabric-cluster-resource-manager-metrics/cluster-resource-manager-metric-weights-impact.png)
...
![The Impact of a Global Only Solution](./media/service-fabric-cluster-resource-manager-metrics/cluster-resource-manager-global-vs-local-balancing.png)
