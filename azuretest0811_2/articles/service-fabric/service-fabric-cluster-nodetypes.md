---
title: Service Fabric node types and VM Scale Sets | Microsoft Azure
...
![Screen shot of a cluster that has two Node Types](./media/service-fabric-cluster-nodetypes/NodeTypes.png)
