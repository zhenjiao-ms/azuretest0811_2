---
title: Resource Balancer cluster description | Microsoft Azure
...
![Nodes organized via fault domains](./media/service-fabric-cluster-resource-manager-cluster-description/cluster-fault-domains.png)
 ...
 ![Two different cluster layouts](./media/service-fabric-cluster-resource-manager-cluster-description/cluster-uneven-fault-domain-layout.png)
...
![Placement With Fault and Upgrade Domains](./media/service-fabric-cluster-resource-manager-cluster-description/cluster-fault-and-upgrade-domains-with-placement.png)
...
![Fault and Upgrade Domain Layouts](./media/service-fabric-cluster-resource-manager-cluster-description/cluster-fault-and-upgrade-domain-layout-strategies.png)
...
![Cluster Layout Different Workloads](./media/service-fabric-cluster-resource-manager-cluster-description/cluster-layout-different-workloads.png)
...
![Placement Constraints and Node Properties](./media/service-fabric-cluster-resource-manager-cluster-description/cluster-placement-constraints-node-properties.png)
...
![Cluster nodes and capacity](./media/service-fabric-cluster-resource-manager-cluster-description/cluster-nodes-and-capacity.png)
