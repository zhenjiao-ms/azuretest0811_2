...
---
title: 'Application upgrade: upgrade parameters | Microsoft Azure'
...
| UpgradeHealthCheckInterval |The frequency that the health status is checked. This parameter is specified in the ClusterManager section of the *cluster* *manifest* .(This is not specified as part of the upgrade cmdlet.) The default value is 60 seconds. |
