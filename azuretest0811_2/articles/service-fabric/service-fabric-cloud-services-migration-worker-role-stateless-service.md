---
title: Guide to converting Web and Worker Roles to Service Fabric stateless services | Microsoft Azure
...
![Service Fabric and Cloud Services project comparison](./media/service-fabric-cloud-services-migration-worker-role-stateless-service/service-fabric-cloud-service-projects.png)
...
![Worker Role to Stateless Service](./media/service-fabric-cloud-services-migration-worker-role-stateless-service/worker-role-to-stateless-service.png)
