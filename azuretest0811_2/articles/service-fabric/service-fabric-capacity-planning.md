...
![Spreadsheet for cost calculation](./media/SF-Cost.png)

## Next steps
Check out [Partitioning Service Fabric services](service-fabric-concepts-partitioning.md) to learn more about partitioning your service.
