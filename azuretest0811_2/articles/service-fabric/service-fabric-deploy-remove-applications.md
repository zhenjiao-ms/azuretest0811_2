---
title: Service Fabric application deployment | Microsoft Azure
...
Once an [application type has been packaged](service-fabric-application-model.md), it's ready for deployment into an Azure Service Fabric cluster. Deployment involves the following three steps:
