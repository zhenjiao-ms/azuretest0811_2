...
![Health entities.](./media/service-fabric-health-introduction/servicefabric-health-hierarchy.png)
...
![Health report aggregation with error report.](./media/service-fabric-health-introduction/servicefabric-health-report-eval-error.png)
...
![Health report aggregation with warning report and ConsiderWarningAsError false.](./media/service-fabric-health-introduction/servicefabric-health-report-eval-warning.png)
...
![Child entities health aggregation.](./media/service-fabric-health-introduction/servicefabric-health-hierarchy-eval.png)
