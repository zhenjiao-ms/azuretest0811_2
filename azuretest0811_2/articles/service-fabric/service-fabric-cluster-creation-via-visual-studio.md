...
![New Project dialog with Azure Resource Group project selected](./media/service-fabric-cluster-creation-via-visual-studio/azure-resource-group-project-creation.png)
...
![Select Azure Template dialog with Service Fabric Cluster template selected](./media/service-fabric-cluster-creation-via-visual-studio/selecting-azure-template.png)
...
![Deploy to Resource Group dialog](./media/service-fabric-cluster-creation-via-visual-studio/deploy-to-azure.png)
