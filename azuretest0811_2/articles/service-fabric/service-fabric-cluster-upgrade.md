---
title: Upgrade a Service Fabric cluster | Microsoft Azure
...
![Screenshot that shows certificate thumbprints in the Azure portal.](./media/service-fabric-cluster-upgrade/CertificateUpgrade.png)

> [!NOTE]
> Before you identify a certificate that you want to use for the cluster resources, you must complete the following steps, or the new certificate will not be used:
> 
...
1. Add a new probe to the appropriate load balancer.
    ...
    ![Screenshot that shows adding a probe to a load balancer in the portal.](./media/service-fabric-cluster-upgrade/addingProbes.png)
2. Add a new rule to the load balancer.
    ...
    ![Screenshot that shows adding a new rule to a load balancer in the portal.](./media/service-fabric-cluster-upgrade/addingLBRules.png)
