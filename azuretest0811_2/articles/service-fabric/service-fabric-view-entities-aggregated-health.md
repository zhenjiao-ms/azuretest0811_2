---
title: How to view Azure Service Fabric entities' aggregated health | Microsoft Azure
...
![View of the cluster with Service Fabric Explorer.](./media/service-fabric-view-entities-aggregated-health/servicefabric-explorer-cluster-health.png)
...
> [!NOTE]
> The unhealthy evaluations show the first reason the entity is evaluated to current health state. There may be multiple other events that trigger this state, but they will not be reflected in the evaluations. You need to drill down into the health entities to figure out all the unhealthy reports in the cluster.
> 
> 
