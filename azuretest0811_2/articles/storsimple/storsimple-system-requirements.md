---
title: StorSimple system requirements | Microsoft Azure
...
* Configure StorSimple with [two-node file server cluster configurations](https://technet.microsoft.com/library/cc731844\(v=WS.10\).aspx). By removing single points of failure and building in redundancy on the host side, the entire solution becomes highly available.
