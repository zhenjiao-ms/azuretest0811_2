---
title: Deploy StorSimple device in Government Portal | Microsoft Azure
...
| [Step 3: Configure and register the device through Windows PowerShell for StorSimple](step 3-configure-and-register-the-device-through-windows-powershell-for-storsimple.md) |Connect the device to your network and register it with Azure to complete the setup using the management service. |
