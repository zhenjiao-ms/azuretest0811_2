---
title: Troubleshoot a deployed StorSimple device | Microsoft Azure
...
You use the setup wizard ([Invoke-HcsSetupWizard](https://technet.microsoft.com/en-us/%5Clibrary/Dn688135\(v=WPS.630\).aspx)) to check the device configuration and take corrective action if necessary.
