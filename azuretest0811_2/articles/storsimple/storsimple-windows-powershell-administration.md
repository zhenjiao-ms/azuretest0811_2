---
title: PowerShell for StorSimple device management | Microsoft Azure
...
> [!NOTE]
> To get a list of all the available cmdlets in any of the runspaces, log in to the corresponding menu option and run the `Get-Command` cmdlet.
> 
> 
