---
title: Deploy the StorSimple Manager service for StorSimple virtual array| Microsoft Azure
...
> [!NOTE]
> You need separate instances of StorSimple Manager service to manage StorSimple 8000 series devices and StorSimple Virtual Arrays.
> 
> 
...
> [!IMPORTANT]
> After a service is deleted, the operation cannot be reversed. 
> 
> 
...
6. Click the check icon ![Check icon](./media/storsimple-ova-manage-service/image7.png) to close this dialog box.
