---
title: How to use Hudson with Blob storage | Microsoft Azure
...
* A Hudson Continuous Integration solution.
  ...
  1. On a Java-enabled machine, download the Hudson WAR from [http://hudson-ci.org/](http://hudson-ci.org/).
