---
title: How to use Table storage from Java | Microsoft Azure
...
Note: An SDK is available for developers who are using Azure Storage on Android devices. For more information, see the [Azure Storage SDK for Android](https://github.com/azure/azure-storage-android).
...
and uses it to create a new **CloudTable** object which represents a table named "people". (Note: There are additional ways to create **CloudStorageAccount** objects; for more information, see **CloudStorageAccount** in the [Azure Storage Client SDK Reference](http://dl.windowsazure.com/storage/javadoc/).)
