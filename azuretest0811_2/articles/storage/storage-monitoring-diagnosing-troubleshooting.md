...
![](./media/storage-monitoring-diagnosing-troubleshooting/hour-minute-metrics.png)
...
![](./media/storage-monitoring-diagnosing-troubleshooting/high-e2e-latency.png)
...
![](./media/storage-monitoring-diagnosing-troubleshooting/fiddler-screenshot.png)
...
4. Add a filter to the **Capture Filter** textbox. For example, **host contosoemaildist.table.core.windows.net** will configure Wireshark to capture only packets sent to or from the table service endpoint in the **contosoemaildist** storage account. Check out the [complete list of Capture Filters](http://wiki.wireshark.org/CaptureFilters).
   ...
   ![](./media/storage-monitoring-diagnosing-troubleshooting/wireshark-screenshot-1.png)
...
![](./media/storage-monitoring-diagnosing-troubleshooting/wireshark-screenshot-2.png)
...
![](./media/storage-monitoring-diagnosing-troubleshooting/wireshark-screenshot-3.png)
...
![](./media/storage-monitoring-diagnosing-troubleshooting/mma-screenshot-1.png)
...
![](./media/storage-monitoring-diagnosing-troubleshooting/mma-screenshot-2.png)
