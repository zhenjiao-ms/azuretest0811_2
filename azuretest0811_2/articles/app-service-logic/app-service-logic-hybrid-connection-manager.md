...
1. In the [Azure classic portal](http://go.microsoft.com/fwlink/p/?LinkID=213885), select your Service Bus namespace, and select **Connection Information**:
    ...
    ![](./media/app-service-logic-hybrid-connection-manager/SB_ConnectInfo.png)
2. Copy the SAS Connection String:
   
    ![](./media/app-service-logic-hybrid-connection-manager/SB_SAS.png)
...
1. In the [Azure portal](http://go.microsoft.com/fwlink/p/?LinkID=525040), select the connector you created. To open it, you can select **Browse**, select **API Apps**, and then select your connector or API App. 
   ...
   <br/>
   ![](./media/app-service-logic-hybrid-connection-manager/BrowseSetupIncomplete.jpg) 
...
3. Copy the **Primary Configuration String**:
   <br/>
   ![](./media/app-service-logic-hybrid-connection-manager/PrimaryConfigString.png)
...
<br/>
![](./media/app-service-logic-hybrid-connection-manager/HybridSetup.jpg) 
...
<br/>
![](./media/app-service-logic-hybrid-connection-manager/BrowseSetupComplete.jpg) 
...
## Troubleshooting
![](./media/app-service-logic-hybrid-connection-manager/HCMFlow.png)
