---
title: Creating a B2B process in Azure App Service | Microsoft Azure
...
1. Create a new flow in which the first step is AS2. Drag and drop the **AS2 Connector** and choose the instance already created. Choose trigger as the functionality:  
    ![](./media/app-service-logic-create-a-b2b-process/Flow.png)  
...
![](./media/app-service-logic-create-a-b2b-process/Tracking.png)
