---
title: Why have you received a notification that your Azure subscription has a past due balance | Microsoft Azure
...
> [!NOTE]
> If your Azure subscription becomes disabled, you can use the steps in this article to re-enable it: [What do I do if my Azure subscription is cancelled?](billing-subscription-become-disable.md)
> 
> 
