---
title: Manage Hadoop clusters in HDInsight with .NET SDK | Microsoft Azure
...
This can also be done via the Portal. See [Administer HDInsight by using the Azure Portal](hdinsight-administer-use-portal-linux.md).
...
* [Administer HDInsight by using the Azure Portal](hdinsight-administer-use-portal-linux.md)
