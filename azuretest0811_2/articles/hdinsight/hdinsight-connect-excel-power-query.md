---
title: Connect Excel to Hadoop with Power Query | Microsoft Azure
...
* **An HDInsight cluster**. To configure one, see [Get started with Azure HDInsight](hdinsight-hadoop-linux-tutorial-get-started.md).
