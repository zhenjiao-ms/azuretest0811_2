...
| --- | --- | --- |
| [yarn.scheduler.capacity.maximum-applications](http://docs.hortonworks.com/HDPDocuments/HDP2/HDP-2.1.3/bk_system-admin-guide/content/setting_application_limits.html) |The maximum number of jobs that can be active concurrently (pending or running) |10,000 |
| [templeton.exec.max-procs](https://hive.apache.org/javadocs/hcat-r0.5.0/configuration.html) |The maximum number of requests that can be served concurrently |20 |
| [mapreduce.jobhistory.max-age-ms](http://docs.hortonworks.com/HDPDocuments/HDP2/HDP-2.0.6.0/ds_Hadoop/hadoop-mapreduce-client/hadoop-mapreduce-client-core/mapred-default.xml) |The number of days that job history will be retained |7 days |
