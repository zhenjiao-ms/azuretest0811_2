---
title: What is HBase in HDInsight? | Microsoft Azure
...
* [Get started using HBase with Hadoop in HDInsight](http://azure.microsoft.com/documentation/articles/hdinsight-hbase-get-started/)
* [Provision HDInsight clusters on Azure Virtual Network](hdinsight-hbase-provision-vnet.md)
...
* [Use Maven to build Java applications that use HBase with HDInsight (Hadoop)](hdinsight-hbase-build-java-maven.md)
