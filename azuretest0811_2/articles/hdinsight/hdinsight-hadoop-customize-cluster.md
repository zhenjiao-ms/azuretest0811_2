...
![HDInsight cluster customization and stages during cluster creation](./media/hdinsight-hadoop-customize-cluster/HDI-Cluster-state.png "Stages during cluster creation")
...
> more information about helper functions, see [Develop Script Action scripts for HDInsight](hdinsight-hadoop-script-actions.md).
> 
> 
...
## See also
* [Create Hadoop clusters in HDInsight](hdinsight-provision-clusters.md) provides instructions on how to create an HDInsight cluster by using other custom options.
