---
title: Configure HBase replication between two datacenters | Microsoft Azure
...
![HDInsight HBase replication virtual network diagram](./media/hdinsight-hbase-geo-replication/HDInsight.HBase.Replication.Network.diagram.png)
...
* [Get started with Apache HBase in HDInsight](hdinsight-hbase-tutorial-get-started.md)
