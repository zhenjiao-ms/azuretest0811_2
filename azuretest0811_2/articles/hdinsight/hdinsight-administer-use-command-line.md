---
title: Manage Hadoop clusters using Azure CLI | Microsoft Azure
...
This article covers only using the Azure CLI with HDInsight. For a general guide on how to use Azure CLI, see [Install and configure Azure CLI](../xplat-cli-install.md).
