---
title: Use Hadoop Oozie in HDInsight | Microsoft Azure
...
Learn how to use Apache Oozie to define a workflow and run the workflow on HDInsight. To learn about the Oozie coordinator, see [Use time-based Hadoop Oozie Coordinator with HDInsight](hdinsight-use-oozie-coordinator-time.md). To learn Azure Data Factory, see [Use Pig and Hive with Data Factory](../data-factory/data-factory-data-transformation-activities.md).
...
2. A Sqoop action exports the HiveQL output to a table in an Azure SQL database. For more information about Sqoop, see [Use Hadoop Sqoop with HDInsight](hdinsight-use-sqoop.md).
...
* **A workstation with Azure PowerShell**. 
    ...
    To execute Windows PowerShell scripts, you must run as an administrator and set the execution policy to *RemoteSigned*. For more information, see [Run Windows PowerShell scripts](https://technet.microsoft.com/en-us/library/ee176961.aspx).
...
For more information about Oozie workflow and using workflow actions, see [Apache Oozie 4.0 documentation](http://oozie.apache.org/docs/4.0.0/) (for HDInsight version 3.0) or [Apache Oozie 3.3.2 documentation](http://oozie.apache.org/docs/3.3.2/) (for HDInsight version 2.1).
...
* [Use Sqoop with Hadoop in HDInsight](hdinsight-use-sqoop.md)
