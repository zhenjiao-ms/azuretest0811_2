---
title: Use Hive with Hadoop for website log analysis| Microsoft Azure
...
## Prerequisites
* You must have provisioned a Hadoop cluster on Azure HDInsight. For instructions, see [Provision HDInsight Clusters](hdinsight-provision-clusters.md). 
