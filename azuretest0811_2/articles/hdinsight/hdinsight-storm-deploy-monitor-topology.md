---
title: Deploy and manage Apache Storm topologies on HDInsight | Microsoft Azure
...
![the submit topology page](./media/hdinsight-storm-deploy-monitor-topology/submit.png)
...
![the storm ui](./media/hdinsight-storm-deploy-monitor-topology/storm-ui-summary.png)
