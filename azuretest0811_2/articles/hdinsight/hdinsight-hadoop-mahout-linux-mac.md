---
title: Generate recommendations using Mahout and Linux-based HDInsight | Microsoft Azure
...
Conveniently, [GroupLens Research](http://grouplens.org/datasets/movielens/) provides rating data for movies in a format that is compatible with Mahout. This data is available on your cluster's default storage at `/HdiSamples/HdiSamples/MahoutMovieData`.
