---
title: Use Hadoop Sqoop in HDInsight | Microsoft Azure
...
[Sqoop](https://sqoop.apache.org/docs/1.4.4/SqoopUserGuide.html) is a tool designed to transfer data between Hadoop 
...
see [What's new in the cluster versions provided by HDInsight?](hdinsight-component-versioning.md).
...
* **Azure SQL database**: You must configure a firewall rule for the Azure SQL database server to allow access from your workstation. For instructions about creating an Azure SQL database and configuring the firewall, see [Get started using Azure SQL database](../sql-database/sql-database-get-started.md). 
...
* **SQL Server**: If your HDInsight cluster is on the same virtual network in Azure as SQL Server, you can use the steps in this article to import and export data to a SQL Server database.
  ...
  * To create and configure a virtual network, see [Virtual Network Configuration Tasks](../services/virtual-machines.md).
...
5. Pre-process the source data file.
    ...
    This procedure creates a new file on the cluster: tutorials/usesqoop/data/sample.log. To examine the modified data file, you can use the Azure portal, an Azure Storage explorer tool, or Azure PowerShell. [Get started with HDInsight](hdinsight-hadoop-linux-tutorial-get-started.md) has a code sample for using Azure PowerShell to download a file and display the file content.
...
8. Import the mobiledata table to the HDInsight cluster.
    ...
    To examine the modified data file, you can use the Azure portal, an Azure Storage explorer tool, or Azure PowerShell.  [Get started with HDInsight](hdinsight-hadoop-linux-tutorial-get-started.md) has a code sample about using Azure PowerShell to download a file and display the file content.
