---
title: 'HBase tutorial: Get started with HBase in Hadoop | Microsoft Azure'
...
> [!VIDEO https://channel9.msdn.com/Series/Getting-started-with-Windows-Azure-HDInsight-Service/Get-started-with-HBase-in-HDInsight/player]
> 
> 
> 
> 
...
3. Enter **Cluster name**, **Cluster size**, HTTP user password, and **Storage account**.
    ...
    ![Create HBase cluster in HDInsight](./media/hdinsight-hbase-tutorial-get-started/hdinsight-hbase-quick-create.png)
...
![hdinsight hbase tabular data](./media/hdinsight-hbase-tutorial-get-started/hdinsight-hbase-contacts-tabular.png)

In HBase which is an implementation of BigTable, the same data looks like:

![hdinsight hbase bigtable data](./media/hdinsight-hbase-tutorial-get-started/hdinsight-hbase-contacts-bigtable.png)
...
5. Insert some data:
    ...
    ![hdinsight hadoop hbase shell](./media/hdinsight-hbase-tutorial-get-started/hdinsight-hbase-shell.png)
6. Get a single row
...
6. Click **Hive Editor** at the top of the page. The Hive Editor looks like this:
    ...
    ![HDInsight cluster dashboard.](./media/hdinsight-hbase-tutorial-get-started/hdinsight-hbase-hive-editor.png)
...
6. Click **stdout**. Save the file and open the file with Notepad. There will be one output file.
    ...
    ![HDInsight HBase Hive Editor File Browser](./media/hdinsight-hbase-tutorial-get-started/hdinsight-hbase-file-browser.png)
