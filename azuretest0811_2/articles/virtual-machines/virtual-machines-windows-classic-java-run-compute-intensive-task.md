---
title: Compute-intensive Java application on a VM | Microsoft Azure
...
![Traveling Salesman Problem solver](./media/virtual-machines-windows-classic-java-run-compute-intensive-task/WA_JavaTSPSolver.png)

The following is an example of the Java application monitoring the compute-intensive task.

![Traveling Salesman Problem client](./media/virtual-machines-windows-classic-java-run-compute-intensive-task/WA_JavaTSPClient.png)
...
Note that the Azure Service Bus functionality requires the Baltimore CyberTrust Root certificate to be installed as part of your JRE's **cacerts** store. This certificate is automatically included in the Java Runtime Environment (JRE) used by this tutorial. If you do not have this certificate in your JRE **cacerts** store, see [Adding a Certificate to the Java CA Certificate Store](../java-add-certificate-ca-store.md) for information on adding it (as well as information on viewing the certificates in your cacerts store).
...
3. In the upper-left pane of the Azure classic portal, click the **Service
   ...
   ![Service Bus Node screenshot](./media/virtual-machines-windows-classic-java-run-compute-intensive-task/SvcBusQueues_02_SvcBusNode.jpg)
4. In the **Create a new Service Namespace** dialog box, enter a
   ...
   **Check Availability** button.  
   ![Create a New Namespace screenshot](./media/virtual-machines-windows-classic-java-run-compute-intensive-task/SvcBusQueues_03_CreateNewSvcNamespace.jpg)
...
1. In the left navigation pane, click the **Service Bus** node to
   ...
   ![Available Namespaces screenshot](./media/virtual-machines-windows-classic-java-run-compute-intensive-task/SvcBusQueues_04_SvcBusNode_AvailNamespaces.jpg)
2. Select the namespace you just created from the list shown.
   ![Namespace List screenshot](./media/virtual-machines-windows-classic-java-run-compute-intensive-task/SvcBusQueues_05_NamespaceList.jpg)
3. The right-hand **Properties** pane lists the properties for the
   new namespace.
   ![Properties Pane screenshot](./media/virtual-machines-windows-classic-java-run-compute-intensive-task/SvcBusQueues_06_PropertiesPane.jpg)
4. The **Default Key** is hidden. Click the **View** button to display
   the security credentials.
   ![Default Key screenshot](./media/virtual-machines-windows-classic-java-run-compute-intensive-task/SvcBusQueues_07_DefaultKey.jpg)
