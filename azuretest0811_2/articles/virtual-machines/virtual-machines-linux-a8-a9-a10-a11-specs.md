---
title: About A8, A9, A10, A11 VM sizes with Linux | Microsoft Azure
...
* **MPI** - Intel MPI Library 5.x
  ...
  > [!NOTE]
  > Intel MPI 5.1 is already installed on the CentOS-based HPC images in the Marketplace. To use Intel MPI on SLES 12 HPC VMs, you must separately install it.
  > 
  > 
...
> [!IMPORTANT]
> This step is **required** for SLES 12 HPC VM deployments in all Azure regions. 
...
> [!NOTE]
> It might take some time to install the drivers, and the command will return without output. After the update, your VM will restart and should be ready for use in several minutes.
> 
> 
