---
title: Using SAP on Linux virtual machines (VMs) | Microsoft Azure
...
[This guide can be found here](virtual-machines-linux-sap-planning-guide.md "SAP NetWeaver on Linux virtual machines \(VMs\) – Planning and Implementation Guide")
...
[This guide can be found here](virtual-machines-linux-sap-deployment-guide.md "SAP NetWeaver on Linux virtual machines \(VMs\) – Deployment Guide")
...
[This guide can be found here](virtual-machines-linux-sap-dbms-guide.md "SAP NetWeaver on Linux virtual machines \(VMs\) – DBMS Deployment Guide")
