---
title: Capture a Linux VM to use as a template | Microsoft Azure
...
> [!TIP]
> If you're interested in creating a custom Linux VM image and uploading it to Azure so you can create VMs from the image, see [Upload and create a VM from custom disk image](virtual-machines-linux-upload-vhd.md).
> 
> 
...
4. Type **exit** to close the SSH client.
   ...
   > [!NOTE]
   > The next steps assume you have already [installed the Azure CLI](../xplat-cli-install.md) on your client computer.
   > 
...
> [!TIP]
> To find the location of an image, open the JSON file template. In the **storageProfile**, find the **uri** of the **image** located in the **system** container. For example, the uri of the OS disk image is similar to `https://xxxxxxxxxxxxxx.blob.core.windows.net/system/Microsoft.Compute/Images/vhds/<your-vhd-name-prefix>-osDisk.xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx.vhd`.
> 
> 
