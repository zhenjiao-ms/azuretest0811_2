---
title: Python web app with Django | Microsoft Azure
...
![A browser window displaying the hello world page on Azure](./media/virtual-machines-windows-classic-python-django-web-app/django-helloworld-browser-azure.png)
...
2. Instruct Azure to direct port 80 traffic from the web to port 80 on the virtual machine:
   ...
   * Open up the **TCP** protocol's **PUBLIC PORT 80** as **PRIVATE PORT 80**.
     ![](./media/virtual-machines-windows-classic-python-django-web-app/django-helloworld-port80.png)
