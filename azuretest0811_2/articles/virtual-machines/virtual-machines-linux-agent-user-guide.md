---
title: Linux Agent User Guide | Microsoft Azure
...
> [!NOTE]
> Please see the Azure Linux agent [README](https://github.com/Azure/WALinuxAgent/blob/master/README.md) for the latest version of this guide.
> 
> 
