---
title: How to use the Azure slave plug-in with Jenkins Continuous Integration | Microsoft Azure
...
These can be found in your [subscription profile](http://go.microsoft.com/fwlink/?LinkID=396395). Below is an example of a subscription profile.
