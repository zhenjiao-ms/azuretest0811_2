...
You can find the code used by the "hello world" module to publish messages in the ['hello_world.c'](https://github.com/Azure/azure-iot-gateway-sdk/blob/master/modules/hello_world/src/hello_world.c) file. The snippet below shows an amended version with additional comments and some error handling code removed for legibility:
...
The **Logger_Recieve** function in the [logger.c](https://github.com/Azure/azure-iot-gateway-sdk/blob/master/modules/logger/src/logger.c) file is the callback the message bus invokes to deliver messages to the logger module. The snippet below shows an amended version with additional comments and some error handling code removed for legibility:
...
* [IoT Gateway SDK – send device-to-cloud messages with a simulated device using Linux](../articles/iot-hub/iot-hub-linux-gateway-sdk-simulated-device.md).
* [Azure IoT Gateway SDK](https://github.com/Azure/azure-iot-gateway-sdk/) on GitHub.
