...
For more information about Event Hubs receive patterns, see the [Event Hubs overview](../articles/event-hubs/event-hubs-overview.md).

This tutorial uses an [HDInsight Storm](../articles/hdinsight/hdinsight-storm-overview.md) installation, which comes with the Event Hubs spout already available.
...
4. In Eclipse, create a new Maven project (click **File**, then **New**, then **Project**).
    ...
    ![](./media/service-bus-event-hubs-getstarted/create-storm1.png)
...
10. Create a new class called **LoggerBolt** with the following code:
    ...
    This Storm bolt logs the content of the received events. This can easily be extended to store tuples in a storage service. The [HDInsight sensor analysis tutorial](../articles/hdinsight/hdinsight-storm-sensor-data-analysis.md) uses this same approach to store data into HBase.
