...
<a name="Fig1"></a>![Diagram of Blobs](./media/cloud-storage/Data_01_Blobs.png)
...
<a name="Fig2"></a>![Diagram of SQL Server in a Virtual Machine](./media/cloud-storage/Data_02_SQLSvrVM.png)
...
<a name="Fig3"></a>![Diagram of SQL Database](./media/cloud-storage/Data_03_SQLdb.png)
...
<a name="Fig4"></a>![Diagram of SQL data sync](./media/cloud-storage/Data_04_SQLDataSync.png)
...
<a name="Fig5"></a>![Diagram of SQL reporting](./media/cloud-storage/Data_05_SQLReporting.png)
...
<a name="Fig6"></a>![Diagram of table storage](./media/cloud-storage/Data_06_TblStorage.png)
...
<a name="Fig7"></a>![Diagram of hadoop](./media/cloud-storage/Data_07_Hadoop.png)
